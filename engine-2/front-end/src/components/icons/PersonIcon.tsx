...
export default function PersonIcon(props: { style?: React.CSSProperties }): React.JSX.Element {
    // The glyph fills its own box, while the burger icon only fills 75 % of its
    // box - the padded viewBox makes both icons read at the same size.
    return (
        <svg
            style={{ width: '100%', height: '100%', ...props.style }}
            viewBox="-3.3 -3.6 26.6 29.2"
        >
            <path
