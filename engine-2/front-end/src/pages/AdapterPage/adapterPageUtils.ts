...
export const parseLicenseParagraphs = (
    markdown: string | undefined,
    removeFrontmatter: (text: string) => string,
): string[] => {
...
export const getBadge = (frontmatter: Record<string, string>, keys: string[], patterns: RegExp[] = []): string => {
