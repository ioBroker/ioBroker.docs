...
* Kategorie: Benachrichtigung/Visualisiereung
...
Bitte beachten Sie, dass sich diese Adapter noch in der Testphase befinden. Die Entwickler freuen sich über jedes Feedback, denn ohne Tester gibt es keinen Fortschritt.
...
Detaillierte Informationen zur Einrichtung und Nutzung findet ihr in der deutschen [Dokumentation des Adapters](https://github.com/MyHomeMyData/ioBroker.flexcharts/blob/master/docs/de/README.md).
...
Für die Nutzung des Adapters wird ein TeslaFi-Konto benötigt. Weitere Informationen zur Installation und Einrichtung findet ihr auf der [GitHub-Seite des Adapters](https://github.com/eifel-tech/ioBroker.cloudless-homeconnect/blob/master/docs/de/README.md).
...
Mehr Informationen zur Nutzung und Konfiguration findet ihr auf der [GitHub-Seite des Adapters](https://github.com/eifel-tech/ioBroker.cloudless-homeconnect/blob/master/docs/de/README.md).
...
Weitere Details zur Nutzung und Konfiguration sind auf der [GitHub-Seite des Adapters verfügbar](https://github.com/eifel-tech/ioBroker.cloudless-homeconnect/blob/master/docs/de/README.md).
...
Dieser Adapter ist perfekt für Nutzer, die ihre Haushaltsgeräte sicher und lokal in ihr Smart Home integrieren möchten. Detaillierte [Anleitungen zur Einrichtung und Nutzung findet ihr in der Dokumentation](https://github.com/eifel-tech/ioBroker.cloudless-homeconnect/blob/master/docs/de/README.md).
...
Weitere Informationen und die Installationsanleitung findet ihr auf der [GitHub-Seite des Adapters](https://github.com/eifel-tech/ioBroker.cloudless-homeconnect/blob/master/docs/de/README.md).
...
Weitere Details findet ihr auf der [GitHub-Seite des Adapters](https://github.com/eifel-tech/ioBroker.cloudless-homeconnect/blob/master/docs/de/README.md).
