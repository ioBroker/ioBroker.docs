...
translatedFrom: en
hash: axvNlskSnys13QaLZklohzbACDf71q76vHgPQ/DfNUw=
---
# Ein Roundup Teil 1: von Oktober 2023 bis November 2023
*Ein „Besser spät als nie“-Überblick über die Neuigkeiten, Adapter und Funktionen von ioBroker*.
In der sich ständig weiterentwickelnden Welt der Heimautomatisierung bleibt ioBroker mit einer Reihe von Updates und Ergänzungen von Oktober 2023 bis Februar 2024 präsent.
Werfen wir einen genaueren Blick auf einige der in dieser Zeit eingeführten Fortschritte, obwohl dieser Blogbeitrag etwas spät kommt.

## Spannende **Neuigkeiten** aus der Heimautomatisierung ESPHome (01.11.2023)
Ein bedeutender Durchbruch für Heimautomatisierungs-Enthusiasten: Die ESPHome-Dokumentation erkennt nun offiziell die Integration von ioBroker mit seiner nativen API an. Diese Entwicklung folgt auf eine kürzlich erfolgte PR-Annahme, die ioBroker neben Home Assistant als eines der ausgewählten Heimautomatisierungssysteme positioniert, das die native API von ESPHome für die direkte Client-Kommunikation nutzt.
...
![Bild 1](images/2023_10_13_material-vacuum.png)

Das neue **Staubsauger**-Widget ist jetzt in ioBroker verfügbar.

Obwohl dieses Widget in erster Linie für die Verwendung mit Xiaomi-Staubsaugern entwickelt wurde, kann es auch mit anderen Staubsaugermodellen verwendet werden.
...
Integrieren Sie Ihr Awtrix Light-Gerät, beispielsweise das Ulanzi TC001, nahtlos über HTTP in Ihr ioBroker-Setup.
...
### Willkommen (17.10.2023), Entwickler: bluefox
...
<img src="https://raw.githubusercontent.com/boergegrunicke/ioBroker.govee-local/main/admin/govee-local.png" width="100" height="100" /> Dieser Adapter ermöglicht die Steuerung von Govee Smart LED Lights-Geräten über den lokalen Zugriff, sodass keine Cloud-Konnektivität erforderlich ist.
...
Bitte beachten Sie, dass die Tests nur mit einer H6051 Lampe durchgeführt wurden.
...
Dieser Adapter dient zur Beurteilung des Gesundheitszustands und der Funktionalitäten eines Pylontech- oder Pytes-Arrays, das aus ein bis fünfzehn Batterien besteht.
...
## Ankündigung der neuen **Funktionen** in ioBroker
### Iobroker (11.10.2023)
...
Diese Funktion ist von unschätzbarem Wert, da sie die Sicherheitsbedenken behebt, die entstehen, wenn der MQTT- oder Admin-Adapter ohne Authentifizierung im Internet offen gelassen wird. Sie dient als Schutz, insbesondere für Benutzer, die sich mit der Sicherung ihrer Adapter nicht gut auskennen.

### Vis (06.11.2023)
Die Lizenz für vis wurde gegenüber MIT einer wesentlichen Änderung unterzogen.
Diese Anpassung bedeutet, dass Sie vis nun kostenlos in kommerziellen Projekten nutzen können und keine zusätzliche Lizenzierung erforderlich ist.

### Willkommen (07.11.2023)
