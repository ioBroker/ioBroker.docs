...
Beim Blockly wird mit dem "steuern"-Block praktisch der Befehl zum Gerät gesendet. (Ack false) Beim "aktualisieren" wird ein Datenpunkt einfach auf einen bestätigten Wert gesetzt. Das macht man, wenn zum Beispiel der Datenpunkt von uns erstellt worden ist und man genau weiß, dass der Wert den aktuellen Stand wiederspiegelt.
