...
Marc zeigt, wie man mit HTML-Widgets und CSS die Hauptseite frei gestalten kann.
Er erklärt, wie man Widgets platziert, anpasst und mit anderen Elementen kombiniert.
...
Mark zeigt, wie man RGBW-Leuchten wie Philips Hue Lampen mit dem RGBW-Widget von JAEGER-Design einbindet.
Er erklärt, wie man die Einstellungen des Widgets anpasst, z. B. Farben, Helligkeit und Weißwert.
...
**Zusätzliche Tipps:**
Mark beantwortet Fragen aus früheren Videos, z. B. wie man Rundungen erstellt.
...
**Quizfrage:**
Wie viele verschiedene Systeme bindet Mark mit dieser Oberfläche ein? (Antwort: Über ein Dutzend)
