...
![纳米比亚](images/2024_03_17_nmea.png)
...
![纳米比亚](images/2024_03_31_NMEA.png)
...
![调度程序](images/2024_04_13 "YouTube 调度程序 Titelbild.png")

### 管理员（2024 年 4 月 6 日）
ioBroker Admin 界面也进行了更新，引入了 JSONConfig 文件中的包含内容。
此新功能允许您合并来自不同文件的数据，从而实现更有条理、更高效的配置过程。

链接：https://github.com/ioBroker/ioBroker.admin/blob/master/packages/jsonConfig/SCHEMA.md#includes（有关包含的更多信息）
