...
translatedFrom: de
hash: xnEypw8ZqGpD90Igm8kSYSwsfEjslIoz8y/C0FqxoMk=
---
...
记录的 ioBrokers [安装量在全球范围内增长](https://www.iobroker.com/statistics) 数量增加到大约 62,000 个。大多数可以在德语国家找到，但俄罗斯和荷兰也有所增加。翻译仍有很大的潜力，任何有时间和意愿的人都可以提供帮助。只需访问 https://weblate.iobroker.net/，创建一个帐户或通过 Github 登录并开始翻译。
