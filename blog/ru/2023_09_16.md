...
title: 
translatedFrom: de
hash: p+32RrQgW4WbtY7Xjyd2p1NtVgpo43k+ULYUm7n8neI=
---
...
Документация по конфигурации JSON добавлена на веб-сайт ioBroker [здесь](https://www.iobroker.com/docs/dev/adapterjsonconfig.md).
