...
translatedFrom: en
hash: yxBdwlEmw3s2oSDctraYQtz6EjL7Wnl59kQ3qUGLfLs=
---
...
Кроме того, он предоставляет индикатор состояния уровня заряда батареи трекера и различных других статусов, полученных из API, обеспечивая комплексные возможности мониторинга.
...
Примечание разработчика. Если у вас есть какие-либо конкретные команды API, которые вы хотели бы включить, сообщите мне об этом.
...
Эта функция расширяет возможности управления сценами, предоставляя структурированный способ группировки и организации сцен на основе определенных категорий.<img src="media/2024_02_16_scenes-enums.png" width="500" />
