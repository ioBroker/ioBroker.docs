# *"Better late than never"* updates and news roundup in ioBroker 
...
//forum.iobroker.net/topic/69067/neuer-befehl-iob-nodejs-update
...
?? The Admin and MQTT adapters now include a functionality to verify their accessibility from the public internet, particularly when no authentication is enabled. If unreachable, both adapters will issue warnings in the log and within the admin interface.
