...
- **[New in Admin: The AI Assistant](https://forum.iobroker.net/topic/84761/neu-im-admin-der-ki-assistant)** – Currently the hottest topic with well over 190 posts. This thread is all about the new AI Assistant in the Admin: user reports, recommended models, and how to connect OpenAI or Anthropic models, in addition to Ollama, via a custom proxy endpoint.
