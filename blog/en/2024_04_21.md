# Detailed roundup of new adapters and features between February and April 2024
...
-Additional scenarios for utilizing ioBroker on a yacht.

[Link to video](https://youtu.be/flp_-mypbRU)

![nmea](images/2024_03_31_NMEA.png)
...
The destination is an id in the directory of the flger, 
wicht delivers you the smoothed values. 
You can limit the min- or max- values. Limit the decimal places 
...
Discover the versatile functionality of the Scheduler adapter, also nown as planer, in this informative video! Learn not only how to install the adapter and make basic settings but also the steps to create profiles and visualize them in vis-2.

[Link to video](https://youtu.be/wlBoR3emhds)

![scheduler](images/2024_04_13 Scheduler für YouTube Titelbild.png)
