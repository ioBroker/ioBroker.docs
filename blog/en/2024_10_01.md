...
translatedFrom: de
hash: 059aIrO7r5YBpJfNMPFijnqxESscBrFyDoXUfyEbWqA=
---
...
The configuration is simple: You create a new client on your Gotify server and insert the generated token into the adapter configuration. The adapter can then receive all messages from the server. You can find further details in [GitHub repository](https://github.com/simatec/ioBroker.gotify-ws).
