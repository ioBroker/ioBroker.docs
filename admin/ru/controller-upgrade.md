# Инструкция по обновлению js-контроллера на хосте ioBroker

Сердцем каждой установки ioBroker является js-контроллер. js-controller содержит центральную конфигурацию установки ioBroker, а также контролирует и отслеживает все процессы адаптера.

Текущая доступная и установленная версия js-контроллера для соответствующего хоста, на котором установлен ioBroker, отображается в интерфейсе администратора в пункте меню «Хосты».
