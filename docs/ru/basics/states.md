...
| `c`      | комментарий о ценности, которую может привнести автор.                      |
...
В редакторе объектов вся эта информация находится на _вкладке_ «Состояние». «Подтверждено» — это флаг подтверждения: зеленый — для **ответа** , как показано на изображении, красный — для **команды** , на которую еще не получен ответ. «Комментарий» — это поле. `c` Вот название скрипта, который записал это значение.
