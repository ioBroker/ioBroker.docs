...
Контроль в Vis. Виджеты используются для отображения или управления состояниями; Например, включение и выключение лампы с помощью кнопки, которая меняет свой внешний вид в зависимости от состояния включения.
