...
Он также обеспечивает доступ к центральным объектам и базам данных состояния, координирует и контролирует все запущенные экземпляры и процессы адаптера. При необходимости адаптеры перезапускаются js-контроллером.
