...
* Если вы уже установили на хосте большое количество адаптеров, вы можете изменить назначение экземпляров, которые уже были установлены, на вкладке «Экземпляры».
