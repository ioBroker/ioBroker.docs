...
| **[облачный адаптер](/docs/cloud/viz.md)**  | Если порт не нужно открывать, соединение устанавливается изнутри наружу; шифрование обрабатывается сервисом.                                                           |
...
3. Браузерный интерфейс с`https://` Позвоните и уточните, прибудет ли оно.
