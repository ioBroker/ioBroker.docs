...
С помощью скрипта установки iobroker на рекомендуемых системах Linux больше не требуется отдельная установка Node.js и npm! См. [Установка под Linux](/docs/install/linux.md)
...
В настоящее время ioBroker рекомендует версию LTS. **Node.js 22**Использовать версии с нечетными номерами нельзя.
