...
С помощью этой кнопки создается новый список. Для этого открывается новое окно
...
Точки данных можно перетащить с правой стороны в желаемое перечисление с левой стороны, просто перетащив их.
