...
С помощью этих двух кнопок можно открыть всю древовидную структуру или
быть закрытым.
...
### 2 - имя
В этом столбце указано название объекта. Кроме того, предыдущий значок показывает, какой это уровень иерархии (устройство, канал или точка данных).
