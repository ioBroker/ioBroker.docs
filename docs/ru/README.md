...
Поэтому может случиться так, что ссылки еще не работают или контент отсутствует. Мы ценим любую помощь в создании новых статей или внесении улучшений. Информация об этом доступна здесь [на форуме][].
...
Адаптеры, доступные в ioBroker, могут, среди прочего, обмениваться данными с централизованно управляемыми календарями или системами умного дома конкретного производителя (которые подключены к локальной или беспроводной локальной сети). Таким образом, программное обеспечение ioBroker может считывать информацию о состоянии или запускать управляющие действия.
...
### IQControl
Достигайте цели быстро, но при этом гибко, вот что отличает iQontrol:
...
Список [разработчиков ioBroker][] можно найти на форуме ioBroker.
