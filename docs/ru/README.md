...
#### Что такое адаптеры?
**Адаптеры** — это **плагины** (программные модули, небольшие программы), написанные на JavaScript для Node.js, специально разработанные для конкретных устройств, типов устройств, устройств определенных производителей или других служб, например для запроса веб-сайтов. .
...
### Джарвис
[Страница адаптера Джарвис](https://www.iobroker.net/#de/adapters/adapterref/iobroker.jarvis/README.md)
...
Редактор Lovelace (принцип WYSIWYG — принцип «что видишь, то и получаешь») позволяет легко создавать современные пользовательские интерфейсы всего за несколько шагов. Для реализации более сложных требований и пожеланий доступны пользовательские карточки и редактор YAML. Вдохновение для пользовательского интерфейса Lovelace можно собрать в мире HomeAssistant, а затем реализовать в ioBroker.
...
Благодаря большому и отзывчивому сообществу было найдено решение для каждой проблемы.
...
В очень редких случаях (в настоящее время менее 5 адаптеров) для использования адаптера требуется (иногда платная) лицензия.
