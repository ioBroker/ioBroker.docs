...
На вкладке "Администратор"
[Протоколы](/docs/admin/log.md)Там вы можете фильтровать по экземпляру, уровню и тексту.

Они лежат на пластине снизу. `/opt/iobroker/log/`Один файл в день. Через кнопку. **Скачать журнал** Вы можете получить полный файл.
