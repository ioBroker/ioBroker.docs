...
Это не адаптер, поэтому он не отображается в списке адаптеров. Его версия указана на вкладке.
[Хозяева](/docs/admin/hosts.md)его обновление выполняется через
