...
#### 4.) Выбор языка
Сайт многоязычный. Постепенно будут добавляться новые языки. Некоторые из них сначала генерируются автоматически, для доработки текстов приглашаются носители языка.
