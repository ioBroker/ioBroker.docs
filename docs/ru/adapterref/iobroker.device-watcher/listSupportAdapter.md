...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.device-watcher/listSupportAdapter.md
title: ioBroker.device-watcher
hash: Lln5Z5qxCRI+hv38HxqJmY1+L4UoYNCKYHxZiwiwdLY=
---
...
Ниже приведён список поддерживаемых адаптеров с информацией о том, какие именно функции поддерживаются каждым адаптером.
