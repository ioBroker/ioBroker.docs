...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.ecoflow-mqtt/doc/devices/wave3.md
title: Штаты для WAVE3
hash: b7i+fvVTz9UHcvrjxKhUSSWYMJ0wrSKIVGh9Vale2AQ=
---
# Штаты для WAVE3
...
| tempPetCareWarning    | Временное предупреждение по уходу за домашними животными |
| powerOffDelaySet      | powerOffDelaySet                                         |
| powerOffDelayRemained | powerOffDelayRemained                                    |
...
| currentTimeTaskV2Item      |   0   |   60  |    А    |   1   | текущая задача времени v2 элемент                               |
...
| plugInInfoPvDcAmpMax       |   0   |   60  |    А    |   1   | информация о вилке PV DC макс.                                  |
...
| tempAmbient                |   0   |  н/д  |    °С   |   1   | Температура на входе?                                           |
| humiAmbient                |   0   |  н/д  |    %    |   1   | влажность?                                                      |
| tempIndoorSupplyAir        |   0   |  н/д  |    °С   |   1   | Температура на выходе?                                          |
| уровень конденсатаВода     |   0   |  100  |    %    |   1   | уровень конденсатаВода                                          |
| powGetSelfConsume          |   0   |  н/д  |    В    |   1   | Самопотребление энергии                                         |
...
| waveOperatingMode        |                           Режим работы волны                           | {0:NULL,1:ОХЛАЖДЕНИЕ,2:ОТОПЛЕНИЕ,3:ВЕНТИЛЯЦИЯ,4:ОСУШЕНИЕ,5:ТЕРМОСТАТИЧЕСКИЙ РЕЖИМ} |
| дренаж                   |                                 дренаж                                 | {0:выкл?,1:вкл?}                                                                   |
| режим дренажа            |                              режим дренажа                             | {0:выкл?,1:вкл?}                                                                   |
| moodLightMode            |                              moodLightMode                             | {0:выкл?,1:вкл?,2:приглушен?}                                                      |
| lcdShowTempType          |                             lcdShowTempType                            | {0:выкл?,1:вкл?}                                                                   |
| enPetCare                |                                enPetCare                               | {0:выкл,1:вкл}                                                                     |
| userTempUnit             |                      Единица измерения температуры                     | {0:не задано?,1:°C (Цельсий),2:°F (Фаренгейт)}                                     |
| petCareWarning           |                             petCareWarning                             | {0:выкл?,1:вкл?}                                                                   |
...
| Состояние      | Имя                            |
| -------------- | ------------------------------ |
| waveModeInfo   | информация о волновом режиме   |
| devErrcodeList | список кодов ошибок устройства |