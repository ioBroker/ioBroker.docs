...
[статусОтчетБатарея4](#statusReportBattery4)

[статусОтчетБатарея5](#statusReportBattery5)

[статусОтчетБатарея6](#statusReportBattery6)
...
| bpTargetSoc     |  0  |   101   |    %    |   1   | Целевой SOC                                |
...
| mpptPwr    |  0  | 20000 |    В    |   1   | Солнечная энергия      |
| bpPwr      |  0  | 20000 |    В    |   1   | Питание от батареи     |
| bpSoc      |  0  |  100  |    %    |   1   | Уровень заряда батареи |
...
| pcsAPhase\_amp               |    0   |   60  |     А     |   1   | Фаза А ток                         |
| pcsAPhase\_actPwr            | -15000 | 15000 |     В     |   1   | Активная мощность фазы А           |
| pcsAPhase\_reactPwr          |  -1000 |  5000 |    вар    |   1   | Реактивная мощность фазы А         |
| pcsAPhase\_apparentPwr       |    0   | 15000 | Вирджиния |   1   | Фаза А, кажущаяся мощность         |
| pcsBPhase\_volt              |    0   |  250  |     В     |   1   | Напряжение фазы B                  |
| pcsBPhase\_amp               |    0   |   60  |     А     |   1   | Фаза B ток                         |
| pcsBPhase\_actPwr            | -15000 | 15000 |     В     |   1   | активная мощность фазы B           |
| pcsBPhase\_reactPwr          |  -1000 | 15000 |    вар    |   1   | Реактивная мощность фазы B         |
| pcsBPhase\_apparentPwr       |    0   | 15000 | Вирджиния |   1   | Полная мощность фазы B             |
| pcsCPhase\_volt              |    0   |  250  |     В     |   1   | Напряжение фазы С                  |
| pcsCPhase\_amp               |    0   |   60  |     А     |   1   | фаза C ток                         |
| pcsCPhase\_actPwr            | -15000 | 15000 |     В     |   1   | Активная мощность фазы C           |
| pcsCPhase\_reactPwr          |  -1000 |  5000 |    вар    |   1   | Реактивная мощность фазы C         |
| pcsCPhase\_apparentPwr       |    0   | 15000 | Вирджиния |   1   | Полная мощность фазы C             |
...
| pcsLoadInfo\_vol             |    0   |  410  |     В     |   1   | напряжение нагрузки                |
| pcsLoadInfo\_amp             |    0   |   35  |     А     |   1   | ток нагрузки                       |
| pcsLoadInfo\_freq            |    0   |   65  |     Гц    |   1   | частота нагрузки                   |
| pcsLoadInfo\_pwr             |    0   | 10000 |     В     |   1   | мощность нагрузки                  |
| bpRemainWatth                |    0   |  н/д  |    кВтч   | 0.001 | остаточная мощность                |
| bpDsgTime                    |    0   |  н/д  |    мин    |   1   | bp dsg время                       |
| pcsActPwr                    |    0   | 20000 |     В     |   1   | ПК акт пв                          |
| pcsAcFreq                    |    0   |   65  |     Гц    |   1   | шт. частота переменного тока       |
| pcsBusVolt                   |    0   |  900  |     В     |   1   | шт. шина вольт                     |
| pcsLeakAmp                   |    0   |  1000 |     мА    |   1   | утечка pcs amp                     |
| pcsBpPower                   |    0   | 10000 |     В     |   1   | шт. BP мощность                    |
...
| sysMulPeakTime    | пиковое время системы муль               |
...
| Состояние      |        Имя        | ценности         |
| -------------- | :---------------: | ---------------- |
| статус зарядки | состояние зарядки | {0:OK?}          |
