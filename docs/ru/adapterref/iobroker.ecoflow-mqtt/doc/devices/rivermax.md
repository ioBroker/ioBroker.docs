...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.ecoflow-mqtt/doc/devices/rivermax.md
title: Штаты для RIVERMAX
hash: K1Nm3X8b8VSrE+OJB+3fEz5hVjrjcFRBro4hVsZiIto=
---
# Штаты для RIVERMAX
...
| Состояние          | Мин |   Макс  | Единица |  Мульт | Имя                                                                                                         |
| ------------------ | :-: | :-----: | :-----: | :----: | ----------------------------------------------------------------------------------------------------------- |
| ваттыВСумм         |  0  |   500   |    В    |    1   | Суммарная входная мощность                                                                                  |
...
| USB3 Вт            |  0  |   500   |    В    |   0.1  | Стандартное питание выхода USB3                                                                             |
