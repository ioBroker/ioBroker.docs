...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.ecoflow-mqtt/doc/devices/rapidpro320.md
title: Штаты для RAPIDPRO320
hash: u9vZ7KEMN1F6PSrk+hdeyHrZilgcDGTfMzqnlyJuauQ=
---
# Штаты для RAPIDPRO320
...
| --------------------- | :-----------------------------------------: | ---------------------------------------------------------------------------------- |
| код ошибки            |            Глобальный код ошибки            | {0:OK?}                                                                            |
...
| batteryMaintainModel  |      Модель поддержания заряда батареи      | {0:0?,1:1?}                                                                        |
| chargeOptCtrlEnable   |           зарядка Оп Ctrl Включить          | {0:0?,1:1?,2:2?}                                                                   |
| chargeOptState        |              зарядка Opt State              | {0:0?,1:1?}                                                                        |
| tempSmartCtrlEnable   |        временное включение Smart Ctrl       | {0:0?,1:1?,2:2?}                                                                   |
| lowPowerDsgCtrlEnable | низкий уровень питания USBP DSG Ctrl Enable | {0:0?,1:1?,2:2?}                                                                   |

### число

| Состояние                      |  Мин  |  Макс | Единица | Мульт | Имя                                           |
| ------------------------------ | :---: | :---: | :-----: | :---: | --------------------------------------------- |
| powInSumW                      |  -400 |  400  |    В    |   1   | Суммарная входная мощность                    |
| powOutSumW                     |  -400 |  400  |    В    |   1   | Суммарная выходная мощность                   |
...
| usbTypeA1DisplayInfo\_usbPow   |  -150 |  150  |    В    |   1   | питание порта USB A                           |
| usbTypeA1DisplayInfo\_usbVolt  |  -50  |   50  |    В    |   1   | напряжение порта USB A                        |
| usbTypeA1DisplayInfo\_usbAmp   |  -10  |   10  |    А    |   1   | ток порта USB A                               |
| usbTypec1DisplayInfo\_usbPow   |  -150 |  150  |    В    |   1   | питание порта USB 1                           |
| usbTypec1DisplayInfo\_usbVolt  |  -50  |   50  |    В    |   1   | напряжение порта USB 1                        |
| usbTypec1DisplayInfo\_usbAmp   |  -10  |   10  |    А    |   1   | ток порта USB 1                               |
| usbTypec2DisplayInfo\_usbPow   |  -150 |  150  |    В    |   1   | питание порта USB 2                           |
| usbTypec2DisplayInfo\_usbVolt  |  -50  |   50  |    В    |   1   | напряжение порта USB 2                        |
| usbTypec2DisplayInfo\_usbAmp   |  -10  |   10  |    А    |   1   | ток порта USB 2                               |
| usbTypec3DisplayInfo\_usbPow   |  -150 |  150  |    В    |   1   | питание порта USB 3                           |
| usbTypec3DisplayInfo\_usbVolt  |  -50  |   50  |    В    |   1   | напряжение порта USB 3                        |
| usbTypec3DisplayInfo\_usbAmp   |  -10  |   10  |    А    |   1   | ток порта USB 3                               |
| usbTypec4DisplayInfo\_usbPow   |  -150 |  150  |    В    |   1   | питание порта USB 4                           |
| usbTypec4DisplayInfo\_usbVolt  |  -50  |   50  |    В    |   1   | напряжение порта USB 4                        |
| usbTypec4DisplayInfo\_usbAmp   |  -10  |   10  |    А    |   1   | ток порта USB 4                               |
| pogopin\_1DisplayInfo\_usbPow  |  -350 |  350  |    В    |   1   | сила прыжка                                   |
| pogopin\_1DisplayInfo\_usbVolt |  -50  |   50  |    В    |   1   | напряжение погопина                           |
| pogopin\_1DisplayInfo\_usbAmp  |  -20  |   20  |    А    |   1   | течение прыжка                                |
| typec3MaxAllowUsbPow           |   0   |  100  |    %    |   1   | тип c 3 Максимально допустимое напряжение USB |
| typec4MaxAllowUsbPow           |   0   |  100  |    %    |   1   | тип c 4 Максимально допустимое напряжение USB |
| typec2MaxAllowUsbPow           |   0   |  100  |    %    |   1   | тип c 2 Максимально допустимое напряжение USB |
| typec1MaxAllowUsbPow           |   0   |  100  |    %    |   1   | тип c 1 Максимально допустимое напряжение USB |
| cmsBattTemp                    |  -20  |   80  |    °С   |   1   | температура батареи                           |
| cmsBattFullCap                 |   0   | 40000 |   мАч   |   1   | основная батарея полностью заряжена           |
| cmsBattDesignCap               |   0   | 40000 |   мАч   |   1   | основная батарея полностью заряжена           |
| cmsBattRemainCap               |   0   | 40000 |   мАч   |   1   | основная батарея полностью заряжена           |
| utcTimezone                    | -1200 |  1200 |         |   1   | часовой пояс UTC                              |
| cmsBattCycleNum                |   0   |  6000 |         |   1   | cms Batt Количество циклов                    |
| cmsEnergyOutSum                |   0   |  н/д  |   Что   |   1   | сумма выходной энергии cms                    |
| cmsEnergyInSum                 |   0   |  н/д  |   Что   |   1   | суммарная энергия cms                         |
...
| screenSaverSwitchEnable         | Включение переключателя заставки         |
| screenSaverDisplayTimes         | Время отображения заставки               |
| screenSaverDisplayIndex         | Индекс отображения заставки              |
| screenClockSwitchEnable         | Включение переключателя экранных часов   |
| screenClockDisplayTimes         | Экранные часы отображают время.          |
| screenClockDisplayFormat        | Формат отображения экранных часов        |
| screenThemeDisplayIndex         | Индекс отображения тем оформления экрана |
| batteryMaintainCycleNum         | Номер цикла поддержания заряда батареи   |
| screenClockDisplayTimesCharging | Экран Часы Отображение времени Зарядка   |
| screenPicPreview                | обзор экрана PicP                        |
| screenSourceFileRecvSta         | Исходный файл экрана Recv Sta            |
...
| ---------------------------------------------------- | :---------: | :-: | ---------------------------------- | ---------------------------------------------------- |
| typec1PortEnable                                     | выключенный |  на | тип c 1 Порт Включить              | {назначение: 2, cmdFunc: 254, cmdId: 17, dataLen: 3} |
| typec2PortEnable                                     | выключенный |  на | тип c 2 Порт Включить              | {назначение: 2, cmdFunc: 254, cmdId: 17, dataLen: 3} |
| typec3PortEnable                                     | выключенный |  на | тип c 3 Порт Включить              | {назначение: 2, cmdFunc: 254, cmdId: 17, dataLen: 3} |
| typec4PortEnable                                     | выключенный |  на | тип c 4 Порт Включить              | {назначение: 2, cmdFunc: 254, cmdId: 17, dataLen: 3} |
| pogopinPortEnable                                    | выключенный |  на | pogopin Port Enable                | {назначение: 2, cmdFunc: 254, cmdId: 17, dataLen: 3} |
| переключатель сигнализации низкого энергопотребления | выключенный |  на | Сигнализация низкого уровня заряда | {назначение: 2, cmdFunc: 254, cmdId: 17, dataLen: 3} |