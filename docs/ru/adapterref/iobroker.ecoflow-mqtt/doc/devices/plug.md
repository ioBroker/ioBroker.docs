...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.ecoflow-mqtt/doc/devices/plug.md
title: Штаты для PLUG
hash: iNaqT9H6hpc6shn/le4TRPBfvNCazRL/fMDRxeU3dMs=
---
# Штаты для PLUG

### версия: 1.4.9

[plug\_heartbeat](#plug_heartbeat)
...
| ------------------------ | :-: | :--: | :-----: | :---: | ---------------------------------------------- |
| максКур                  |  0  |  11  |    А    |  0.1  | Максимальная сила тока вилки переменного тока. |
| температура              |  0  |  80  |    °С   |   1   | Температура свечи зажигания                    |
| частота                  |  0  |  52  |    Гц   |   1   | Частота переменного тока вилки                 |
| текущий                  |  0  |  11  |    А    | 0.001 | Вилка переменного тока                         |
| вольт                    |  0  |  250 |    В    |   1   | Вилка переменного напряжения                   |
| ватты                    |  0  | 2500 |    В    |  0.1  | Вставьте сетевой адаптер переменного тока.     |
| частота сердцебиения     |  0  |  20  |    Гц   |   1   | Подключение сердцебиения                       |
| время безотказной работы |  0  |  н/д |    с    |   1   | Время бесперебойной работы умной розетки       |
| geneNum                  |  0  |  20  |   шт.   |   1   | Количество PS                                  |
| consNum                  |  0  |  20  |   шт.   |   1   | Количество вилок, подключенных к блоку питания |
| geneWatt                 |  0  |  800 |    В    |  0.1  | Выходная мощность потока(ов) энергии           |
| розетки                  |  0  | 1000 |    В    |  0.1  | Мощность вилок                                 |
| parentWifiRssi           | -90 |  10  |   дБм   |   1   | родительский Wi-Fi RSSI                        |

### выключатель

| Состояние     |  выключенный  |    на    | Имя                             | команда                         |
| ------------- | :-----------: | :------: | ------------------------------- | ------------------------------- |
| выключатель   |  выключенный  |    на    | Выключатель                     | {cmdFunc:2,cmdId:129,dataLen:2} |
| meshEnable    | неполноценный | включено | Включить сетку Plug Mesh        | {cmdFunc:2,cmdId:138,dataLen:2} |
| dynWattEnable |  выключенный  |    на    | Динамическое включение мощности | {cmdFunc:2,cmdId:142,dataLen:2} |

### уровень

| Состояние |  Мин | Макс | Единица |   Мульт  | Имя                                          | команда                         |
| --------- | :--: | :--: | :-----: | :------: | -------------------------------------------- | ------------------------------- |
| яркость   |   0  |  100 |    %    | 0.097752 | Яркость вилки                                | {cmdFunc:2,cmdId:130,dataLen:3} |
| макс. Вт  | 1000 | 2500 |    В    |     1    | Максимальная мощность сети переменного тока. | {cmdFunc:2,cmdId:137,dataLen:3} |
...
| Состояние | Мин |  Макс | Единица | Мульт | Имя                           |
| --------- | :-: | :---: | :-----: | :---: | ----------------------------- |
| ватт5     |  0  | 60000 |   Что   |   1   | Энергия умной розетки         |
| ватт6     |  0  |  1440 |   мин   |   1   | Время включения умной розетки |