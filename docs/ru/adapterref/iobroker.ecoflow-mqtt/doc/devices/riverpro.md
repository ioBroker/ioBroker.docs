...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.ecoflow-mqtt/doc/devices/riverpro.md
title: Штаты для RIVERPRO
hash: rkqdF8JdRSD3M1DDMLX5fOJYMndB9+S/pD4y8uQOuro=
---
# Штаты для RIVERPRO
...
| tagChgVol        |  0  |  100  |    В    |  0.001 | Целевое напряжение зарядки               |
...
| bqSysStatReq | Регистр защиты оборудования BQ                            |
...
| cfgAcChgModeFlg          | флаг режима зарядки от сети переменного тока | {0:?,1:?}                                                                                                                                                                                                 |
| cfgFanMode               |               режим вентилятора              | {0:disabled,1:Level 1,2:Level 2,3:Level 3}                                                                                                                                                                |
...
| inTemp                 |  0  |  80  |    °С   |   1   | Температура инвертора                     |
| invInAmp               |  0  |  13  |    А    | 0.001 | Входной ток инвертора                     |
| invInFreq              |  0  |  62  |    Гц   |   1   | Входная частота инвертора                 |
| инВТоль                |  0  |  250 |    В    | 0.001 | Входное напряжение инвертора              |
...
| автомобильный переключатель | выключенный |   на  | выключатель автомобильного зарядного устройства | {from:Android,operateType:TCP,id:689699572,lang:en-us,params:{id:34,enabled:1},version:1.0} |
...
| ваттыВСумм         |  0  |   660   |    В    |    1   | Суммарная входная мощность                                                                                  |
| ваттыВыходнаяСумма |  0  |   4000  |    В    |    1   | Суммарная выходная мощность                                                                                 |
| светодиодные ватты |  0  |   100   |    В    |   0.1  | выходная мощность светодиода                                                                                |
| типcТемп           |  0  |    80   |    °С   |    1   | Температура типа С                                                                                          |
| типcВатты          |  0  |   500   |    В    |    1   | Выходная мощность Type-C                                                                                    |
| USB 3 Вт           |  0  |   500   |    В    |   0.1  | Стандартное питание выхода USB3                                                                             |
...
| --------- | :-------------------: | ---------------- |
| errCode   | Глобальный код ошибки | {0:OK?}          |
| ledState  |  состояние светодиода | {0:выкл?,1:вкл?} |
...
| sysVer    | Версия системы         |
| bmsSlave  | BMS ведомое устройство |
