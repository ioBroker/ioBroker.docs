...
* значение расчетной мощности, которая может быть использована для начала зарядки (это означает, что зарядка начнется, даже если имеется недостаточный излишек - рекомендуется 0 Вт для 1 фазы зарядки, от 500 Вт до 2000 Вт для 3 фазы зарядки)
...
* минимальная продолжительность сеанса зарядки (даже если излишка больше не хватает, сеанс зарядки будет длиться как минимум в этот раз - рекомендуется 300 секунд)
