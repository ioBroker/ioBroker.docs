...
Чтобы зарядить ваш автомобиль в соответствии с избытком (например, фотоэлектрическими элементами), вы также можете определить состояния, которые представляют избыток и потребление сети основной мощности. Эти значения используются для расчета силы тока, которая может быть использована для зарядки. С помощью дополнительных значений вы можете определить
...
* значение потребляемой мощности сети, которое может быть использовано для начала зарядки (это означает, что зарядка начнется даже при недостаточном избытке — рекомендуется 0 Вт для 1-фазной зарядки, от 500 Вт до 2000 Вт для 3-фазной зарядки)
...
* время всегда заряжать автомобиль сразу после подключения к сети и требуется авторизация (чтобы предотвратить ошибку, при которой без немедленной зарядки дальнейшая зарядка невозможна)
...
Если у вас есть аккумуляторное хранилище, заполните параметры здесь. Указывая состояния излишков и потребления сети вашего аккумуляторного хранилища, этот адаптер может контролировать, следует ли использовать аккумуляторное хранилище для зарядки вашего автомобиля или нет, в зависимости от стратегии, указанной в параметрах.

### Немецкий §14a EnWG ограничение мощности
В соответствии с немецким законом §14a EnWG существует возможность ограничить зарядную станцию макс. фиксированным значением 6 А или динамическим значением потребления сети 3x6 А (4,140 Вт)
...
* kecontact.n.automatic.addPower - определяет количество ватт потребляемой сети, разрешенное для зарядки вашего автомобиля (то же самое, что и в опциях)
