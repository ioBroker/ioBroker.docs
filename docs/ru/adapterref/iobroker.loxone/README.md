...
<img src="admin/loxone.png" width="128" alt="Логотип Loxone" />
...
- 0 = работает, нормальный режим работы, ожидание нажатия аварийной кнопки
...
- `disableEndTime` (ro) Время окончания времени отключения элемента управления
...
- «минус» (wo) изменяет предыдущее настроение
