...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.life360ng/docs/en/README.md
title: без названия
...
- [Общий](/#/docs/adapterref/iobroker.life360ng/docs/en/general.md)
- [Мои места](/#/docs/adapterref/iobroker.life360ng/docs/en/myplaces.md)
- [Интеграция](/#/docs/adapterref/iobroker.life360ng/docs/en/integration.md)
- [Судовой журнал](/#/docs/adapterref/iobroker.life360ng/docs/en/tracker.md)
- [Отображение карты](/#/docs/adapterref/iobroker.life360ng/docs/en/mapdisplay.md)
- [Уведомления](/#/docs/adapterref/iobroker.life360ng/docs/en/notifications.md)
- [Передовой](/#/docs/adapterref/iobroker.life360ng/docs/en/advanced.md)
- [Помощь](/#/docs/adapterref/iobroker.life360ng/docs/en/help.md)

Каждая запись содержит ссылку на отдельную подстраницу с подробными пояснениями к соответствующей вкладке в настройках адаптера.
...
3. Admin-Adapter 7.6.20 (или более новая версия)
4. Веб-адаптер (только при использовании журнала)