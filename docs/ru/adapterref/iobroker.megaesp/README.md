...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.megaesp/README.md
title: без названия
hash: rrEFJwkYerquTCblm5SJhcy1XC38din97wXnJcyH6f4=
---
![логотип](../../../en/adapterref/iobroker.megaesp/admin/megad.png) ioBroker Мега-ESP адаптер =================

![Версия NPM](http://img.shields.io/npm/v/iobroker.megaesp.svg)
![Загрузки](https://img.shields.io/npm/dm/iobroker.megaesp.svg)
![NPM](https://nodei.co/npm/iobroker.megaesp.png?downloads=true)

Позволяет контролировать [Мега-ESP](http://ab-log.ru/forum/viewtopic.php?f=1&t=1130) через Ethernet.
...
### Информация
Устройство имеет 10 портов, входы / выходы.
...
ioBrokerValue = MegaESPValue * коэффициент + смещение;
...
MegaESPValue = (ioBrokerValue - смещение) / коэффициент;
