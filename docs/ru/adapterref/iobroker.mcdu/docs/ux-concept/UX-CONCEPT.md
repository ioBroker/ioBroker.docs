...
- Количество товаров превышает допустимое для отображения (14 строк)
...
- Не очищает буфер обмена (буфер обмена остается).
...
10. **Отображение статуса** : светодиоды + страница статуса = мгновенный обзор состояния дома.
