...
➡️ См. [документацию по API sendTo](/#/docs/adapterref/iobroker.google-spreadsheet/docs/sendTo-API.md) для получения информации об общем использовании и всех доступных командах. Функция чтения ячейки позволяет считывать данные из определенной ячейки в электронной таблице Google.
...
**Результат обратного вызова:**`{ value: any }` со значением ячейки, или`{ error: string }` при неудаче.

## Блокли

![Блокли](../../../../../en/adapterref/iobroker.google-spreadsheet/docs/img/blockly-read-cell.png)
...
Приведённый фрагмент кода считывает данные из определённой ячейки электронной таблицы.
