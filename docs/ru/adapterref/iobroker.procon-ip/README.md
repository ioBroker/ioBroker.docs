...
Более подробную информацию можно получить по следующей ссылке (извините, она только на немецком языке; документацию/информацию на английском языке я пока не нашел):
