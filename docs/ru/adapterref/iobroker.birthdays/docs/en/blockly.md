...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.birthdays/docs/en/blockly.md
...
![Пример Blockly](../../../../../de/adapterref/iobroker.birthdays/docs/en/img/blockly-example.png)
