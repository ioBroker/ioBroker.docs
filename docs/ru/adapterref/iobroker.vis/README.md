...
- `round(N)` - округлить значение до N знаков после запятой, например 34,678;раунд(1) => 34,7
...
Если пользователь изменит вид или на старте, переменные будут заполнены визу с
