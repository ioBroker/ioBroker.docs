...
hash: GkCqnwmi9QPEx+TtHsQKjSuk13mEZT3Uzb3B9sqmAO0=
---
# ioBroker.oasecontrol

![Тестирование и выпуск](https://github.com/mr-suw/ioBroker.oasecontrol/workflows/Test%20and%20Release/badge.svg)

## Адаптер oasecontrol для ioBroker

ioBroker.oasecontrol управляет наружными устройствами из OASE. Поддерживаются устройства серии InScenio FM-Master EGC.
...
**Опрос \[с]:** как часто в секундах следует опрашивать устройство OASE для получения новых данных.
