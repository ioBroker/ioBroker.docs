...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.megad/README.md
title: без названия
hash: ukQz4Z7heTE/fNMzOhsx6fPwXwoF/mzDxc9CDSpp0oc=
---
![логотип](../../../en/adapterref/iobroker.megad/admin/megad.png) адаптер ioBroker MegaD-328 =================

![Количество установок](http://iobroker.live/badges/megad-stable.svg)
![Версия NPM](http://img.shields.io/npm/v/iobroker.megad.svg)
![Загрузки](https://img.shields.io/npm/dm/iobroker.megad.svg)
![тесты](https://travis-ci.org/ioBroker/ioBroker.megad.svg?branch=master)
![NPM](https://nodei.co/npm/iobroker.megad.png?downloads=true)

Позволяет контролировать [MegaD-328](http://www.ab-log.ru/smart-house/ethernet/megad-328) через Ethernet.
...
### Информация
Устройство имеет 14 портов, 0-7 входов и 8-13 выходов.
