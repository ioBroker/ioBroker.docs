...
Например, с помощью ioBroker можно управлять освещением и громкоговорителем шлюза.
...
* После успешного входа в систему добавьте устройство через `+`
...
#### IOS
* [Приложение для iOS] (https://itunes.apple.com/de/app/mi-home-xiaomi-smarthome/id957323480?mt=8) загрузите, установите, откройте и
...
Появятся другие пункты меню> Если сразу не работает, повторите шаги
...
Найдите адаптер в области *Адаптер* и установите его с помощью значка `+`.
