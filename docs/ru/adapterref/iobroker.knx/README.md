...
Перед началом: Каждый DPT com.Objects должен быть установлен в вашем проекте ETS. Каждое устройство следует отсортировать по структуре вашего объекта.
...
Без этих требований адаптер невозможно установить или он не будет работать должным образом.
...
Если вы уже создали новую лицензию в соответствии с [https://iobroker.net](https://iobroker.net/), вы можете вставить ее в (2) ИЛИ вы можете получить ее непосредственно в Интернете, нажав (1)
...
8. Кнопка загрузки файла: здесь можно перетащить и перетащить файл или щелкнуть диалоговое окно выбора файла. Здесь вы можете загрузить свой экспорт ETS в формате `knxproj`.
...
3. Находящийся в состоянии акта адрес:
...
* Из-за возможности запроса статуса следует отметить одну вещь: необходимо убедиться, что ioBroker генерирует не более 40 запросов в секунду, поскольку они могут быть сгенерированы физически.
