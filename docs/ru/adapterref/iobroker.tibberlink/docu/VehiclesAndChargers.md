...
> Примечания разработчиков/исследователей по API данных (конечные точки, схема устройства, возможности) находятся в файле [../info/TibberDataAPI.md](/#/docs/adapterref/iobroker.tibberlink/info/TibberDataAPI.md) .
