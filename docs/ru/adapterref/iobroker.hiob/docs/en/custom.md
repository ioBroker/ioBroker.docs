...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.hiob/docs/en/custom.md
title: без названия
hash: AdpKWlnJR4UucT27cZPx9wzVgpufCqTMdJL3iwb60S4=
---
![Логотип](../../../../../en/adapterref/iobroker.hiob/admin/hiob.png)

- [Вернуться к сводке](/#/docs/adapterref/iobroker.hiob/docs/en/README.md)
- [Шаг 2: Создание перечислений (ENUM).](/#/docs/adapterref/iobroker.hiob/docs/en/enum.md)
...
## Пользовательские настройки`Custom Theme Settings`

- Здесь можно изменить цвет заголовка и переключателя.
- С`App bar Elevation` Высоту заголовка можно определить.
- Размер шрифта можно установить с помощью`Textscale` .

![app\_theme\_seetings.png](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_theme_seetings.png)

- Выберите свой стиль.

![app\_theme\_seetings\_style.png](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_theme_seetings_style.png)

- Цвет семени: Выбирает цвет.

![app\_theme\_seetings\_color.png](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_theme_seetings_color.png)
