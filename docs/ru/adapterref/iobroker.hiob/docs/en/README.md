...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.hiob/docs/en/README.md
title: Адаптер ioBroker.hiob для ioBroker
hash: 4q/raMEpEwJsWyT3ws1LBMiZn1rW2ItzwmZlek5WPaM=
---
![Логотип](../../../../../en/adapterref/iobroker.hiob/admin/hiob.png)

# Адаптер ioBroker.hiob для ioBroker
...
- [Общие настройки](/#/docs/adapterref/iobroker.hiob/docs/en/general.md)
- [Защищенное соединение](/#/docs/adapterref/iobroker.hiob/docs/en/secureCon.md)
- [Простое шифрование AES](/#/docs/adapterref/iobroker.hiob/docs/en/aessecure.md)

# Пользовательские настройки

- [Пользовательские настройки темы](/#/docs/adapterref/iobroker.hiob/docs/en/custom.md)
- [Уведомления](/#/docs/adapterref/iobroker.hiob/docs/en/notifications.md)