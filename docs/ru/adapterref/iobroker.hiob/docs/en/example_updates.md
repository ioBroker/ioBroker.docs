...
# Информация, новости и обновления ioBroker

### 1. Предоставьте адаптеру JavaScript версии >= 7.9.0 необходимые права.

![example\_info\_js.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_js.png)

### 2. Импортируйте скрипт Blockly.

- `host_name` Название хоста (см. изображение ниже)

- `lang` Возможные языки: en, de, ru, pt, nl, fr, it, es, pl, uk и zh-cn

- `channelname` Название канала в папке 0\_userdata.0

- `load_temp` температура от малины

- `debugging` Включает вывод логов

- [Blockly Script](#blockly-script---javascript-adapter--790) </br>![example\_info\_blockly.png](img/example_update/example_info_blockly.png)</br>![example\_info\_hostname.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_hostname.png)

### 3. Создайте перечисление.

- Создайте новый перечислимый тип и добавьте в него 3 штата.</br>![example\_info\_enum.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_enum.png)

### 4. Создайте виджет таблицы.

- **Выберите таблицу и штат для получения обновлений (виджет).**
...
- **Скопируйте таблицу для получения информации и новостей.**
...
- **Выберите таблицу и штат для получения информации, затем настройте столбцы и добавьте их.**
...
- **Выберите таблицу и штат для раздела «Новости», затем отрегулируйте количество столбцов и добавьте их.**
