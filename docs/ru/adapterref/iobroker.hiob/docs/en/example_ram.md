...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.hiob/docs/en/example_ram.md
title: ioBroker RAM
hash: a7R7iBUPz/s3EnIs21Q3t/6qb97Ah7UB9PJtz83Wdcg=
---
...
### 1. Импортируйте скрипт Blockly.

- `channelname` Название канала в папке 0\_userdata.0
- `debugging` Включает вывод логов
- [Blockly Script](#blockly-script---javascript-adapter--790)</br>![example\_ram\_script.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_script.png)

### 2. Создайте перечисление.

- Создайте новый перечислимый тип и добавьте в него 6 штатов.</br>![example\_ram\_enum.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_enum.png)

### 3. Создайте виджеты, таблицы и значения.

- **Выберите виджет таблицы и укажите значение для memRss.**

![example\_ram\_create\_table.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_table.png)

- **Создать столбцы добавить**

![example\_ram\_create\_table\_columns.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_table_columns.png)

- **Скопируйте виджет таблицы для memTotal и memUsed.**

![example\_ram\_create\_copy.png](../en/img/example_ram/example_ram_create.png)![example\_ram\_create\_copy\_1.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_1.png)

- **Выберите виджет таблицы и укажите значение параметра memTotal.**

![example\_ram\_create\_table\_total.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_table_total.png)

- **Выберите виджет таблицы и укажите параметр memUsed.**

![example\_ram\_create\_table\_used.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_table_used.png)

- **Выберите виджет значения и укажите значение для memRss.**

![example\_ram\_create\_value\_rss.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_value_rss.png)

- **Выберите виджет «Значение» и укажите значение для memTotal.**

![example\_ram\_create\_value\_total.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_value_total.png)

- **Выберите виджет значения и укажите параметр memUsed.**

![example\_ram\_create\_value\_used.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_value_used.png)

- **Созданы виджеты**

![example\_ram\_create\_widget\_done.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_widget_done.png)

### 4. Создание экрана

- **Создать экран**

![example\_ram\_create\_screen.png](../en/img/example_ram/example_ram_create_screen.png)</br>![example\_ram\_create\_screen\_pic.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_screen_pic.png)

- **Добавьте виджеты и создайте 3 группы для memRss, memTotal и memUsed.**

![example\_ram\_create\_screen\_done.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_create_screen_done.png)

- **Теперь добавьте таблицы в соответствующие группы.**

![example\_ram\_group\_rss.png](../en/img/example_ram/example_ram_group_rss.png)</br>![example\_ram\_group\_total.png](../en/img/example_ram/example_ram_group_total.png)</br>![example\_ram\_group\_used.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram_group_used.png)

### 5. Готово

![example\_ram\_template.png](../en/img/example_ram/example_ram_template.png)</br>![example\_ram.gif](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_ram/example_ram.gif)
