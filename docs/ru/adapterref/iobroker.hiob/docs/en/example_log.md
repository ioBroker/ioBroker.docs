...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/ru/adapterref/iobroker.hiob/docs/en/example_log.md
title: Журналы ioBroker
hash: h7yiW9wxywyVVaI1bRxYXwKgquKXkkB6piZ6M0p6/mY=
---
...
### 1. Установите адаптер Log Parser.

![example\_log\_logparser.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_logparser.png)

### 2. Установите собственные фильтры (добавлены фильтры «Отладка» и «Все»).

![example\_log\_logparser\_instance.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_logparser_instance.png)

### 3. Импортируйте скрипт Blockly.

[Blockly Script](#blockly-script)

### 4. Выполните необходимые настройки.

- `max` Количество записей в логах. Не должно превышать число, указанное в настройках экземпляра парсера.
- `datapointname` Названия штатов
- `channelname` Имя из папки в каталоге 0\_userdata.0
- `debug` Выводит логи из скрипта.
- `datapoint_logparser` состояния из парсера логов - по умолчанию logparser.0.visualization.table0.json

![example\_log\_blockly.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_blockly.png)

### 5. Создайте перечисление.

- Добавлено государство`logparser.0.visualization.table0.selection` и `0_userdata.0.<name>.logparser`

![example\_log\_enum.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_enum.png)

### 6. Создать виджет Advanced/Flebible

- **Множественный выбор и выбор состояния**

![example\_log\_app\_multi.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_multi.png)

- **Создать выделение добавить**

![example\_log\_app\_multi\_add.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_multi_add.png)

### 7. Создайте таблицу виджетов.

- **Выберите таблицу и штат**

![example\_log\_app\_table.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_table.png)

- **Создать столбцы добавить**

![example\_log\_app\_table\_1.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_table_1.png)

- **Созданные виджеты**

![example\_log\_app\_widgets.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_widgets.png)

### 8. Создать экран

- **Добавьте виджеты и создайте группу.**

![example\_log\_app\_screen.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_screen.png)

- **Добавить виджеты в группу**

![example\_log\_app\_screen\_group.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_screen_group.png)

### 9. Готово

![example\_log\_app\_screen\_ready.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_screen_ready.png)

![example\_log\_app\_screen\_ready\_gif.gif](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_log_app_screen_ready_gif.gif)
