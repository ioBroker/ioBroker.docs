...
### Состояние можно установить в значение «истина» с помощью кнопки.

- Проведите пальцем влево, чтобы удалить виджет.
- Нажмите на знак плюса в правом нижнем углу.

![низ](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_template.png)

- Выпадающий список: выберите`Button` .
- Название: Название виджета
- Значение (необязательно): Отображаемый текст в виджете. Если ничего не указано, используется имя.
- Текст кнопки (необязательно): Этот текст отображается на кнопке.

![низ](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button.png)

- Устройство: Выберите нужный товар в списке.

![низ](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button_device.png)

- Точка данных: Выбор штатов из выбранного списка.

![низ](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button_dp.png)
...
![низ](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button_done.png)
