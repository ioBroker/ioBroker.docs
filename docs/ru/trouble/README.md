...
## IoBroker внезапно больше недоступен, но мой компьютер по-прежнему? (системный журнал или что-то в этом роде)
## Весь хост внезапно зависает во время работы (переключаем верх ...)
