...
## После обновлений операционной системы ioBroker больше не работает (проверьте версии узлов и что-то в этом роде)
...
## При установке адаптера появляется окно с сообщением «index.html не найден»? (Установить Admin3)
