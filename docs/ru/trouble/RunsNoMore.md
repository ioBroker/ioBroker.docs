...
Подробную информацию об обновлении Node.js можно найти в [руководстве по обновлению Node.js.](/docs/install/updatenode.md)
...
Дополнительную информацию об установке Node.js и NPM можно найти в [руководстве по установке Node.js.](/docs/install/nodejs.md)
...
**Важно:** НИКОГДА не пытайтесь вручную удалить или переустановить NPM! Это обычно приводит к дальнейшим проблемам. Вместо этого используйте следующее:`iob nodejs-update` который NPM настраивает автоматически.
...
**ВАЖНО:** Никогда`chmod 777` Используйте это! Это представляет собой угрозу безопасности и часто не решает проблему.
