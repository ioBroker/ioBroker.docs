...
hash: n4mQquYZNAJlP+4VNTg2JUCZyy4OEkGk930btchArio=
---
# Основная концепция
...
* `enum` - объекты, содержащие в common.members массив, указывающий на состояния, каналы, устройства или файлы. перечисления могут иметь родительское перечисление (возможна древовидная структура)
...
* `common.states` (необязательный) — предоставить больше контекста для допустимых значений для состояний с типами данных string и number:
