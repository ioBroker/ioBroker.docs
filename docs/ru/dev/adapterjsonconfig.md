...
### `selectSendTo`
Показывает раскрывающееся меню с указанными в экземпляре значениями.
...
| вариант | описание |
|--------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `type` | Если элемент не имеет атрибута `type`, предположим, что он имеет тип по умолчанию 'panel'. Тип элемента. Для текущих доступных опций см. [Общие элементы управления:](#common-control-elements) |
...
| `expertMode` | если этот флаг установлен в значение true, это поле будет отображаться только в том случае, если режим эксперта установлен в значение true |
| `expertMode` | если этот флаг установлен в значение true, это поле будет отображаться только в том случае, если режим эксперта установлен в значение true |
