...
- [**`checkbox`:**](#checkbox) Флажок для булевых значений
- [**`checkDocker`:**](#checklicense) Специальный компонент для проверки доступности докера. Если да, можно активировать флажок.
