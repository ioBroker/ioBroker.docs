...
| `bundlerType` | Если модуль написан на TypeScript, установите его в `module`. Из Admin 7.5.x |
...
| `setOnEnterKey` | Значение в этом случае будет отправлено только при нажатии кнопки "Enter". Его можно комбинировать с `showEnterButton` |
