...
В конце концов, все данные снова доступны, и была создана новая система.
...
Здесь также резервное копирование, созданное в старой системе, и, если необходимо, резервное копирование Redis, резервное копирование zigbee и т. Д., Затем выполняется с помощью программы sftp, такой как FileZilla или WinSCP.
