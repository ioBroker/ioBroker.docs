...
!> Vorher ein [Backup](https://www.iobroker.net/#de/documentation/config/backup.md)
anlegen. Und **niemals** eine Hauptversion überspringen oder auf eine ungerade
Version wechseln.

Der vollständige Ablauf steht unter
[Node.js aktualisieren](https://www.iobroker.net/#de/documentation/install/updatenode.md).
