...
>Sollte hierbei keine Ausgabe erfolgen, wird das USB-Gerät eventuell als ttyUSB eingebunden (ls -l /dev/ttyUSB*) oder ist kein USB CDC class Gerät (damit können alle Punkte zum einbinden vom ttyACM igoniriert werden)
