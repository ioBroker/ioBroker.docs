...
title: Was ist neu
hash: dmzFT3d4zijWZN1dL2UlKg1lrjapMBwsKY8zpvfBqkc=
---
# Was ist neu

## Anleitung für Autoren

- Bitte definieren Sie die Kopfzeile wie folgt:
...
- Die Aufnahmebeschreibung könnte lauten:
  ...
  - neue Funktion
  - neues Widget
- Wenn Sie Neuigkeiten zum neuen Adapter haben, fügen Sie bitte einen GitHub-Link und ein Logo des Adapters hinzu. Beispiel:
...
## Benachrichtigungsmanager (21.08.2023) – neuer Adapter
...
- WYSIWYG-Editor für die Benutzeroberfläche, aber Sie können auch zur Quelltextansicht oder zur geteilten Ansicht wechseln.
...
- komplexe Bindungen mit eingebettetem JavaScript und Konverter
- einfache Skriptsprache, die über eine Benutzeroberfläche erstellt werden kann.
...
Dieser Adapter dient zur Steuerung von Heizsystemen. Sie können zwischen Kühl- und Heizbetrieb wählen und die Boost- oder Pausenfunktion für einen Raum aktivieren. Außerdem lässt sich die Zieltemperatur für einen Raum überschreiben.
...
Dieses Widget ist primär für Xiaomi-Staubsauger gedacht. Es kann aber auch mit anderen Staubsaugern verwendet werden. Der einzige Unterschied besteht darin, dass Xiaomi die Raumreinigung unterstützt.
...
Für Smart-Home-Fans gibt es eine wichtige Neuigkeit: Die ESPHome-Dokumentation hat die Integration von ioBroker in die native API offiziell bestätigt. Dieses Update folgt der Annahme eines kürzlich eingereichten Pull Requests und positioniert ioBroker neben Home Assistant als eines der wenigen Smart-Home-Systeme, die die native ESPHome-API für die direkte Client-Kommunikation nutzen.

Die native API, bekannt für ihr hochoptimiertes Netzwerkprotokoll, bietet zahlreiche Vorteile gegenüber herkömmlichen MQTT-Methoden und vereinfacht die Interaktion von Smart-Geräten innerhalb des Ökosystems. Mit dieser Anerkennung bekräftigt ESPHome sein Engagement für effiziente und robuste Kommunikationskanäle für die Smart-Home-Branche.
...
## solaredge (15.02.2024): neuer Adapter

[https://github.com/iobroker-community-adapters/ioBroker.soleredge](https://github.com/iobroker-community-adapters/ioBroker.solaredge)
...
Dieser Adapter ermöglicht den Anschluss von ioBroker an den NMEA-2000-Yachtbus. Sie können Geschwindigkeit über Grund (SOG), Kurs über Grund (COG), GPS-Position, Tiefe, Wind, Temperatur und viele weitere Daten vom NMEA-2000-Bus auslesen und sogar den Raymarine-Autopiloten steuern.

![NMEA](../../en/history/media/2024_03_17_nmea.png)

## vis-homekittiles (25.03.2024): Neuer Adapter
...
Adapter für Tedee-Schlösser. Dieser Adapter nutzt die lokale Bridge-API zur Steuerung eines Tedee-Schlosses. Alle Schlösser von Tedee werden unterstützt.

## Prozess-ID (22.04.2024): Neuer Adapter
...
## hiob (22.05.2024): Neuer Adapter spätestens
...
## notificationforandroidtv (22.05.2024): neuer Adapter ab der neuesten Version
...
## Admin (10.06.2024): Neue Funktion
...
## egigeozone2 (6.8.2024): Neuer Adapter in stabiler Version
...
## hiob (17.8.2024): Neuer Adapter in stabil
...
## Extron (17.08.2024): Neuer Adapter bei stabil
...
## rainbird (17.09.2024): Neuer Adapter im stabilen Zustand
...
[https://github.com/Nb-dy/ioBroker.oxxify-fan-control](https://github.com/N-b-dy/ioBroker.oxxify-fan-control)
...
## battrium-bms (4.4.2025): Neuer Adapter
...
Klimaanlagen von Mitsubishi Heavy Industries mit WLAN-Adapter WF-RAC. Dieser Adapter integriert WF-RAC (WLAN)-fähige Klimaanlagen von Mitsubishi Heavy Industries in ioBroker.
...
Zusätzlich zur WebSocket-Kommunikation im Browser können Entwickler die Backend-Socket-Kommunikation nutzen, um mit dem ioBroker-System zu kommunizieren. Sie können mit bestehenden WebSocket- oder Admin-Adaptern kommunizieren oder einen eigenen Socket-Server erstellen.
...
Dieser Adapter liest die Daten vom SofarCloud-Server und speichert sie im Datenpunkt sofarcloud. Der SofarCloud-Server speichert Daten von Sofar-Wechselrichtern.
...
Dieser ioBroker-Adapter ermöglicht die Integration von XSense-Geräten in das ioBroker Smart-Home-System. Er empfängt Daten von XSense-Rauchmeldern, CO-Meldern und anderen kompatiblen Geräten und stellt diese in ioBroker für Automatisierung und Überwachung zur Verfügung. Der Adapter kommuniziert mit dem XSense-Cloud-Server und bietet eine einfache Möglichkeit, XSense-Geräte in bestehende ioBroker-Installationen einzubinden.
...
Verbindet sich mit Ihrem lokalen Autodarts Board Manager (über IP und Port, z. B. 192.168.xx:3180) und stellt ioBroker-Zustände für die Hausautomation bereit:
...
Dieser Adapter verbindet ioBroker mit der Grohe Smarthome/Ondus-Cloud und stellt Grohe-Geräte als Zustände (und einige Steuerelemente) in ioBroker bereit. Er unterstützt:
...
## nextcloudtalk (15.05.2026): Neuer Adapter im stabilen Repository
...
## mspa (15.05.2026): Neuer Adapter im stabilen Repository
...
## brunner-eas3 (21.5.2026): Neuer Adapter im stabilen Repository
...
## Homewizard (21.06.2026): Neuer Adapter im stabilen Repository
...
## al-ko (21.6.2026): Neuer Adapter im stabilen Repository
...
## google-sharedlocations2 (24.06.2026): Neuer Adapter im stabilen Repository
...
## govee-smart (24.06.2026): Neuer Adapter im stabilen Repository
...
## foxesscloud (16.06.2026): Neuer Adapter im stabilen Repository
...
## PlayStation (11.07.2026): Neuer Adapter im stabilen Repository
...
## jetframe (16.08.2026): Neuer Adapter im stabilen Repository
...
## leapmotor (17.08.2026): Neuer Adapter im stabilen Repository
...
## bosch-smart-home-camera (17.08.2026): Neuer Adapter im stabilen Repository
