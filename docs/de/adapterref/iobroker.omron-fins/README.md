...
![Test und Freigabe](https://github.com/TheBam1990/ioBroker.omron-fins/actions/workflows/test-and-release.yml/badge.svg)

# ioBroker.omron-fins

Verbinden Sie Omron CP-, CV-, CS-, CJ-, NJ- und kompatible NX-SPSen mit ioBroker über das FINS-Protokoll via UDP oder TCP.

Deutsche Dokumentation: [READMEde.md](/#/docs/adapterref/iobroker.omron-fins/READMEde.md)
...
## CX-Programmer Symboltabellenimport
...
- `info.connection` trifft nur nach einer erfolgreichen SPS-Antwort zu.
- `info.lastError` enthält den aktuellsten Kommunikations- oder Konfigurationsfehler.
