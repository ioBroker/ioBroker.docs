...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.mcdu/docs/architecture/IOBROKER-ADAPTER-ARCHITECTURE.md
title: ioBroker MCDU-Adapter - Architekturspezifikation
hash: 7eR3iOKDB75rTo+XZ+2zv2M0CeeVjPYF6N+fxKWuruk=
---
# ioBroker MCDU-Adapter – Architekturspezifikation

**Version:** 1.0\
&#x20;**Datum:** 16.02.2026\
&#x20;**Status:** Entwurfsphase\
&#x20;**Autor:** Felix Hummel (basierend auf der ioBroker Best Practices-Recherche)

---

## 🎯 Zusammenfassung

Dieses Dokument beschreibt die Architektur eines produktionsreifen ioBroker-Adapters, der WINWING MCDU-Hardware über MQTT mit der ioBroker-Hausautomation verbindet.

**Hauptmerkmale:**

- ✅ **Flexibles Seitensystem:** Hierarchische Seiten mit anpassbaren Inhalten
- ✅ **Intelligente Integration:** Automatische Erkennung von ioBroker-Datenpunkten
- ✅ **Vorlagensystem:** Vorgefertigte Seitenkonfigurationen
- ✅ **Standardkonform:** Befolgt die Best Practices des ioBroker-Adapters.
- ✅ **Für die Community geeignet:** Gut dokumentiert, wartungsfreundlich, veröffentlichungsfähig

**Architekturansatz:** JSON-Konfiguration mit optionalen benutzerdefinierten Komponenten

**Entwicklungszeit:** 2-3 Wochen bis zum produktionsreifen Adapter
...
### 1. Konfigurationsstruktur (nativ)

Gespeichert in`io-package.json` unter`native` :
...
### 2. Laufzeitobjektbaum

Erstellt vom Adapter in der ioBroker-Objektdatenbank:
...
## 🎨 Konfigurations-UI (JSON-Konfiguration)

### jsonConfig.json-Struktur
...
## 💻 Backend-Implementierung (main.js)

### Adapterklassenstruktur
...
Vorlagen sind vorkonfigurierte Seitenstrukturen, die Benutzer laden und anpassen können:

**Integrierte Vorlagen:**

- `home` - Übersicht zur Hausautomation mit Navigation zu Unterseiten
- `climate` - Temperaturüberwachung und Thermostatsteuerung
- `lights` - Lichtschalter mit Kipptasten
- `energy` - Überwachung von Solaranlagen, Stromnetz und Batterien
- `security` - Alarmanlage und Türsensoren
- `custom` - Leere Seite für die manuelle Konfiguration

**Ablauf beim Laden von Vorlagen:**

1. Der Benutzer wählt eine Vorlage aus dem Dropdown-Menü aus.
2. Klickt auf die Schaltfläche „Vorlage laden“.
3. Der Adapter empfängt`sendTo` Befehl
4. Gibt eine vorkonfigurierte Seitenstruktur zurück
5. JSON-Konfiguration füllt Formular automatisch aus (`useNative: true` )
6. Der Benutzer passt die Datenquellen an.
7. Speichert die Konfiguration

**Anpassung der Vorlage:**

- Benutzer können Beschriftungen, Farben und Ausrichtungen ändern.
- Ersetzen Sie die Platzhalterdatenquellen durch die tatsächlichen ioBroker-Zustände.
- Zeilen hinzufügen/entfernen
- Funktionen der Schaltflächen ändern
- Seiten für ähnliche Layouts klonen
...
**Tag 1-2: Projektvorbereitung**

- [ ] Erstellen Sie eine Adapterstruktur mit`npx @iobroker/create-adapter`
- [ ] Konfigurieren`io-package.json` (adminUI, native Struktur)
- [ ] Erstellen Sie grundlegende`main.js` Skeleton
- [ ] MQTT-Verbindung einrichten

**Tag 3-4: Objektstruktur**

- [ ] Implementieren`setupObjects()` Verfahren
- [ ] Logik zum Erstellen von Seiten-/Zeilenobjekten erstellen
- [ ] Laufzeit-/Steuerungsobjekte erstellen
- [ ] Erstellung des Testobjektbaums

**Tag 5–7: Konfigurations-UI**

- [ ] Erstellen`jsonConfig.json` Struktur
- [ ] Seiten im Akkordeon-Stil mit Tabelle hinzufügen
- [ ] Allgemeines Einstellungsfeld hinzufügen
- [ ] Registerkarte „Geräte hinzufügen“
- [ ] Test-Admin-Schnittstelle

**Liefergegenstand:** Der Adapter installiert sich und zeigt die Konfigurations-Benutzeroberfläche an.

---

### Phase 2: Kernfunktionalität (Woche 2)

**Tag 8-9: Datenintegration**

- [ ] Implementieren`subscribeToDataSources()`
- [ ] Zustandsänderungshandler hinzufügen
- [ ] Automatische Datenpunkterkennung implementieren
- [ ] Testen Sie die Abonnements des Status.

**Tag 10-12: Display-Rendering**

- [ ] Implementieren`renderCurrentPage()` Verfahren
- [ ] Textformatierung hinzufügen (sprintf)
- [ ] Bewertung der Farbregeln hinzufügen
- [ ] Füge Ausrichtungslogik hinzu.
- [ ] Testen von MQTT-Anzeigeaktualisierungen

**Tag 13-14: Tastenbedienung**

- [ ] Implementieren`handleButtonEvent()` Verfahren
- [ ] Schaltflächen-zu-Zeilen-Zuordnung hinzufügen
- [ ] Aktionsausführung hinzufügen (Navigation, Umschalten, Inkrementieren)
- [ ] Testen Sie den gesamten Ablauf der Schaltflächen.

**Lieferumfang:** Funktionsfähiger Adapter mit funktionierendem Display und Tasten

---

### Phase 3: Polnisch (Woche 3)

**Tag 15-16: Vorlagensystem**

- [ ] Implementieren`getTemplates()` Verfahren
- [ ] Hinzufügen`loadTemplate` Nachrichtenverarbeitung
- [ ] Erstellen Sie 5-6 integrierte Vorlagen
- [ ] Laden der Testvorlage

**Tag 17-18: Geräteverwaltung**

- [ ] Geräteregistrierungsverfolgung hinzufügen
- [ ] Gerätestatusverwaltung hinzufügen
- [ ] Aktualisieren Sie den Geräte-Tab in der Admin-Benutzeroberfläche.
- [ ] Test der Unterstützung mehrerer Geräte

**Tag 19-20: Fehlerbehandlung und Testen**
...
**Tag 21: Dokumentation**

- [ ] Schreibe README.md
- [ ] Benutzerhandbuch erstellen
- [ ] Dokumentvorlagensystem
- [ ] Codekommentare hinzufügen

**Liefergegenstand:** Serienfertiger Adapter

---

### Phase 4: Optionale Erweiterungen (ab Woche 4)

**Benutzerdefinierte React-Komponente:**

- Live-Vorschau von MCDU
- Visuelle Linienbearbeitung
- Datenquellen per Drag & Drop
- Testmodus mit Beispieldaten

**Erweiterte Funktionen:**

- Seitenverlauf/Breadcrumbs
- Eingabemodus (Tastatureingabe)
- Benutzerdefinierte Seitenhintergründe
...
- Logik zur Objekterstellung
- Textformatierung und -ausrichtung
- Farbregelauswertung
- Bedingungsanalyse

### Integrationstests

- MQTT-Verbindung und Nachrichtenverarbeitung
- Abonnement und Aktualisierungen des Bundesstaates
- Verarbeitung von Schaltflächenereignissen
- Seitendarstellung

### End-to-End-Tests

1. Adapter installieren
2. MQTT-Verbindung konfigurieren
3. Vorlage laden
4. Datenquellen anpassen
5. Konfiguration speichern
6. MCDU-Gerät anschließen
7. Test-Tastendrücke
8. Überprüfen Sie, ob die Anzeige aktualisiert wurde.
9. Testseitennavigation
10. Testen Sie die Konfiguration mit mehreren Geräten
...
- **main.js** - Adapterlogik (\~1000 Zeilen)
- **lib/templates.js** - Templatedefinitionen (separate Datei)
- **lib/formatter.js** – Textformatierungs-Hilfsprogramme
- **lib/mqtt-handler.js** - MQTT-Protokollverarbeitung

### Protokollierungsstrategie

- **Info** - Lebenszyklusereignisse (Start, Verbindung, Fehler)
- **Debug** – Detaillierte Betriebsabläufe (Rendering, Abonnements, Nachrichten)
- **Warnung** – Behebbare Probleme (fehlende Konfiguration, Verbindungsabbrüche)
- **Fehler** – Kritische Fehler (Verbindungsverlust, ungültige Konfiguration)

### Leistungsüberlegungen

- **Render-Drosselung** – Maximal 10 Aktualisierungen/Sek. (konfigurierbar)
- **Seitencaching** – Gerenderte Inhalte für 100 ms zwischenspeichern
- **Zustandsbündelung** – Mehrere Zustandsänderungen in einem einzigen Rendering zusammenfassen.
- **MQTT QoS** – Verwenden Sie QoS 1 für Befehle, QoS 0 für Statusmeldungen.
...
**1. Erweiterte Anzeigemodi**

- Vollbildbenachrichtigungen (Warnungen, Nachrichten)
- Flussdiagramme (Energiefluss, Wasserfluss)
- Diagramme/Grafiken (Temperaturtrends)
- Benutzerdefinierte ASCII-Kunst

**2. Eingabemodus**

- Eingabe über numerische Tastatur für Thermostate
- Texteingabe für Beschriftungen
- Auswahllisten (Dropdown-Menüs)

**3. Skriptunterstützung**

- JavaScript-Ausdrücke in Schaltflächenaktionen
- Bedingte Anzeigeformatierung
...
- Benutzerprofile mit unterschiedlichen Seitensätzen
- Zugriffskontrolle pro Seite
- Aktivitätsprotokollierung

**6. Cloud-Synchronisierung**

- Konfigurationen sichern/wiederherstellen
- Vorlagen mit der Community teilen
...
4. **Leitfaden zur Fehlerbehebung**
   - Häufige Probleme
...
1. **Architekturübersicht** (dieses Dokument)

2. **API-Referenz**
   - Nachrichtenbehandler (sendTo-Befehle)
   - Objektstruktur
   - MQTT-Protokoll

3. **Leitfaden für Mitwirkende**
   - Code-Stil
   - Testanforderungen
   - Pull-Request-Prozess

4. **Leitfaden zur Vorlagenerstellung**
   - Vorlagenstruktur
   - Bewährte Verfahren
   - Einreichungsprozess
...
- ✅ Die Admin-Benutzeroberfläche ermöglicht die Seitenkonfiguration
- ✅ Verbindet sich mit einem MQTT-Broker
- ✅ Zeigt ioBroker-Status auf dem MCDU an
- ✅ Verarbeitet Tastendrücke
- ✅ Unterstützt Seitennavigation
- ✅ Mindestens 3 integrierte Vorlagen
- ✅ Automatische Erkennung von Datenpunkten
- ✅ Unterstützt mehrere MCDU-Geräte
...
- ✅ i18n-Unterstützung (Englisch + Deutsch)

### Erstklassig (optional)

- ✅ Alle Kriterien für die Produktionsreife
- ✅ Benutzerdefinierte React-Editorkomponente
- ✅ Live-Vorschau für MCDU
- ✅ Erweiterte Anzeigemodi
- ✅ Community-Vorlagenbibliothek
- ✅ Video-Tutorials
...
- **Beispieladapter:**
  ...
  - Szenen: <https://github.com/ioBroker/ioBroker.scenes>
  - Admin: <https://github.com/ioBroker/ioBroker.admin>

### MCDU-Ressourcen

- **Phase 3a Spezifikation:** [PHASE3A-SPEC.md](https://github.com/Flixhummel/ioBroker.mcdu/blob/main/docs/architecture/PHASE3A-SPEC.md)
- **MQTT-Protokoll:** [MQTT-TEST-COMMANDS.md](https://github.com/Flixhummel/ioBroker.mcdu/blob/main/docs/architecture/MQTT-TEST-COMMANDS.md)
- **Hardwaretreiber:** [lib/mcdu.js](https://github.com/Flixhummel/ioBroker.mcdu/blob/main/docs/architecture/lib/mcdu.js)

---

## 🏁 Fazit

Diese Architektur bietet eine **produktionsreife Grundlage** für den MCDU ioBroker-Adapter:

**Stärken:**

- ✅ Befolgt die Best Practices von ioBroker.
- ✅ Standardkonform und bereit für die Gemeinschaft
- ✅ Gut dokumentiert und wartungsfreundlich
- ✅ Flexibel und erweiterbar
- ✅ Schnelle Entwicklungszeit (2-3 Wochen)

**Nächste Schritte:**

1. Architektur prüfen und genehmigen
2. Adapterprojektstruktur erstellen
3. Beginn der Implementierungsphase 1
4. Iterieren Sie basierend auf dem Testfeedback

**Geschätzte Entwicklungszeit:**

- Woche 1: Grundlagen (Objektstruktur, Konfigurations-UI)
- Woche 2: Kernfunktionen (Rendering, Schaltflächen)
- Woche 3: Feinschliff (Vorlagen, Dokumentation, Tests)
- Woche 4+: Optionale Erweiterungen (benutzerdefinierter Editor)

**Erwartetes Ergebnis:** Ein professioneller, zur Veröffentlichung geeigneter Adapter, bereit für die ioBroker-Community!
