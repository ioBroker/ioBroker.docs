...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/glacier55.md
title: Staaten für GLACIER55
hash: trXrIutgJeuVWAqIkmYoc2vDsIecRJ6VTUSnwL3aXTg=
---
# Staaten für GLACIER55
...
| unbekannt623      | unbekannt623              |
| unbekannt631      | unbekannt631              |
| unbekannt746      | unbekannt746              |
...
| plugInInfoPvFlag    | Steckerinformationen PV-Flagge | {0:XT60-Stecker-Netzteil entfernt,1:XT60-Stecker-Netzteil angeschlossen}           |
| plugInInfoPvType    |   Steckerinformationen PV-Typ  | {0:Netzkabel entfernt, nur Batteriebetrieb,1:Netzkabel angeschlossen}              |
| plugInInfoDcpInFlag |  Plug-in-Info DCP-Eingangsflag | {0:Batterie nicht eingelegt,1:Batterie eingelegt}                                  |
| tempUnit            |        Temperatureinheit       | {0: nicht festgelegt?,1:°C (Celsius),2:°F (Fahrenheit)}                            |
| lidStatus           |        Deckel-/Türstatus       | {0:Geschlossen,1:Offen}                                                            |
| Zonenstatus         |   Zonenstatus (Abteiltrenner)  | {0:Zwei Zonen,1:Einzelzone (im Einzelzonenmodus ist der linke Sollwert maßgebend)} |
| temporäre Warnung   |         Temperaturalarm        | {0:aus,1:ein}                                                                      |
...
| LCD-Beleuchtung      |  0  |  100  |    %    | 0.390625 | Bildschirmhelligkeit              |
| Bildschirmauszeit    |  0  |  1800 |    S    |     1    | Bildschirm-Timeout (s)            |
...
| cmsBattDesignCap     |  0  |  1000 |    Wh   |     1    | CMS-Batterie-Designkappe          |
| cmsBattPowOutMax     |  0  |  4000 |    W    |     1    | CMS-Batterieleistung maximal      |
| cmsBattPowInMax      |  0  |  4000 |    W    |     1    | CMS-Batterieleistung in maximaler |
| tempMonitorLeft      | -30 |   40  |    °C   |     1    | Temperaturmonitor links           |
| tempMonitorRight     | -30 |   40  |    °C   |     1    | Temperaturmonitor rechts          |
| Betriebszeit 749     |  0  | n / A |    S    |   0.001  | Eiszeitdauer                      |
| Eingangsspannung 777 |  0  |   40  |    V    |     1    | Eingangsspannung                  |

### Ebene

| Zustand        | Min |  Max  | Einheit | Mult | Name                   | cmd                                     |
| -------------- | :-: | :---: | :-----: | :--: | ---------------------- | --------------------------------------- |
| devStandbyTime |  0  | 96400 |   min   |   1  | Geräte-Timeout         | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
...
| setPointLeft   | -20 |   20  |    °C   |   1  | Solltemperatur links   | {dest:2,cmdFunc:254,cmdId:17,dataLen:6} |
| setPointRight  | -20 |   20  |    °C   |   1  | Solltemperatur richtig | {dest:2,cmdFunc:254,cmdId:17,dataLen:6} |
| batProtect     |  0  |   3   |         |   1  | Starterbatterieschutz  | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |

### schalten

| Zustand         | aus |  An | Name              | cmd                                     |
| --------------- | :-: | :-: | ----------------- | --------------------------------------- |
| enBeep          | aus |  An | Signalton ein/aus | {dest:2,cmdFunc:254,cmdId:17,dataLen:2} |
| Kindersicherung | aus |  An | Kindersicherung   | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| einfacher Modus | aus |  An | einfacher Modus   | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| Kühlmodus       | aus |  An | Kühlmodus         | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
