...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/plug.md
title: Staaten für PLUG
...
[Plug-Herzschlag](#plug_heartbeat)
...
| Zustand    |         Name         | Werte    |
| ---------- | :------------------: | -------- |
| Fehlercode |   Steckerfehlercode  | {0:OK ?} |
| Warncode   | Warncode für Stecker | {0:OK ?} |

### Zeichenkette

| Zustand            | Name                                 |
| ------------------ | ------------------------------------ |
| Land               | Installationsland                    |
| Stadt              | Install Town                         |
| Reset-Grund        | Grund für Zurücksetzung              |
| rtcResetReason     | Grund für RTC-Reset                  |
| resetCount         | Zähler zurücksetzen                  |
| lanState           | LAN-Zustand                          |
| stackFree          | Stapelfrei                           |
| stackMinFree       | Mindestanzahl an kostenlosen Stapeln |
| Mesh-ID            | Netz-ID                              |
| Mesh-Ebene         | Netzschicht                          |
| selfMac            | selbst Mac                           |
| parentMac          | übergeordneter Mac                   |
| otaDlErr           | ota dl err                           |
| otaDlTlsErr        | ota dl tls err                       |
| staIpAddr          | sta ip addr                          |
| matterFabric       | Materiegewebe                        |
...
| ------------------ | :-: | :---: | :-----: | :---: | -------------------------------------------------- |
| maxCur             |  0  |   11  |    A    |  0.1  | Maximaler Strom im Stecker                         |
| Temperatur         |  0  |   80  |    °C   |   1   | Steckertemperatur                                  |
| Frequenz           |  0  |   52  |    Hz   |   1   | Netzfrequenz                                       |
| aktuell            |  0  |   11  |    A    | 0.001 | Netzstrom                                          |
| Volt               |  0  |  250  |    V    |   1   | Netzspannung                                       |
| Watt               |  0  |  2500 |    W    |  0.1  | Netzstecker                                        |
| Herzschlagfrequenz |  0  |   20  |    Hz   |   1   | Herzschlag anschließen                             |
| Betriebszeit       |  0  | n / A |    S    |   1   | Betriebszeit der intelligenten Steckdose           |
| Gennummer          |  0  |   20  |  Stück  |   1   | PS-Betrag                                          |
| consNum            |  0  |   20  |  Stück  |   1   | Anzahl der an das Netzteil angeschlossenen Stecker |
| geneWatt           |  0  |  800  |    W    |  0.1  | Ausgangsleistung des/der Stroms/Stroms             |
| Netzstecker        |  0  |  1000 |    W    |  0.1  | Leistung der Stecker                               |
| parentWifiRssi     | -90 |   10  |   dBm   |   1   | RSSI des Eltern-WLANs                              |

### schalten

| Zustand          |     aus     |     An     | Name                        | cmd                             |
| ---------------- | :---------: | :--------: | --------------------------- | ------------------------------- |
| schalten         |     aus     |     An     | Steckerschalter             | {cmdFunc:2,cmdId:129,dataLen:2} |
| Mesh-Aktivierung | deaktiviert | ermöglicht | Plug Mesh aktivieren        | {cmdFunc:2,cmdId:138,dataLen:2} |
| dynWattEnable    |     aus     |     An     | Dynamische Watt-Aktivierung | {cmdFunc:2,cmdId:142,dataLen:2} |

### Ebene

| Zustand    |  Min |  Max | Einheit |   Mult   | Name                  | cmd                             |
| ---------- | :--: | :--: | :-----: | :------: | --------------------- | ------------------------------- |
| Helligkeit |   0  |  100 |    %    | 0.097752 | Steckerhelligkeit     | {cmdFunc:2,cmdId:130,dataLen:3} |
| maxWatts   | 1000 | 2500 |    W    |     1    | Maximale Netzleistung | {cmdFunc:2,cmdId:137,dataLen:3} |
...
| Zustand | Min |  Max  | Einheit | Mult | Name                               |
| ------- | :-: | :---: | :-----: | :--: | ---------------------------------- |
| watth5  |  0  | 60000 |    Wh   |   1  | Energie des intelligenten Steckers |
| watth6  |  0  |  1440 |   min   |   1  | Smart-Steckdose EIN-ZEIT           |