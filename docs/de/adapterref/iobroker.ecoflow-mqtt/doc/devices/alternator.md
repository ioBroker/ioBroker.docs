...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/alternator.md
title: Staaten für Lichtmaschine
hash: MeadgY0zbqGCU/Df+0CKFnneZrX0SYPb2cdag3Gd780=
---
# Staaten für Lichtmaschine

### Version: 1.4.9

[Lichtmaschine Herzschlag](#alternatorHeartbeat)

## Lichtmaschine Herzschlag

### diagnostisch

| Zustand |    Name    | Werte                                                                      |
| ------- | :--------: | -------------------------------------------------------------------------- |
| Status1 | X\_status1 | {0:keine Unterspannung,32:Unterspannung am Anschluss an die Autobatterie.} |
...
| Lichtmaschinenleistung |   0  |   900  |    W    |   1  | Lichtmaschinenleistung                |
| Autobatterievolt       |  10  |   30   |    V    |   1  | Spannung der Autobatterie             |
| batSoc                 |   0  |   100  |    %    |   1  | Ladezustand der Powerstation-Batterie |
| unbekannt269           |   0  | 144000 |   min   |   1  | Akkuladezeit                          |
| chargeToFull268        |   0  | 144000 |   min   |   1  | Akkuladezeit                          |
| StationPower           |   0  |   900  |    W    |   1  | Kraftwerksleistung                    |
| wifiRssi               | -100 |   10   |   dBm   |   1  | WLAN-RSSI                             |
| Nennleistung           |   0  |   800  |    W    |   1  | Nennleistung des Generators           |

### schalten

| Zustand      | aus |  An | Name                 | cmd                                      |
| ------------ | :-: | :-: | -------------------- | ---------------------------------------- |
| switchOFF130 | aus |  An | Ausschalten (Befehl) | {dest:20,cmdFunc:254,cmdId:17,dataLen:3} |
| StartStopp   | aus |  An | Start/Stop-Befehl    | {dest:20,cmdFunc:254,cmdId:17,dataLen:3} |

### Ebene

| Zustand        | Min | Max | Einheit | Mult | Name                           | cmd                                      |
| -------------- | :-: | :-: | :-----: | :--: | ------------------------------ | ---------------------------------------- |
| Anlaufspannung |  11 |  30 |    V    |  0.1 | Anlaufspannung                 | {dest:20,cmdFunc:254,cmdId:17,dataLen:4} |
| Betriebsmodus  |  1  |  3  |         |   1  | Betriebsmodus                  | {dest:20,cmdFunc:254,cmdId:17,dataLen:3} |
| permanentWatts |  0  | 800 |    W    |   1  | Permanente Leistungsbegrenzung | {dest:20,cmdFunc:254,cmdId:17,dataLen:6} |
| Kabellänge 608 |  0  |  10 |    M    |   1  | X\_cableLength608              | {dest:20,cmdFunc:254,cmdId:17,dataLen:6} |

### Zeichenkette

| Zustand      | Name          |
| ------------ | ------------- |
| unknown427   | X\_unknown427 |
| unbekannt428 | X\_unknown428 |
| unbekannt609 | X\_unknown609 |