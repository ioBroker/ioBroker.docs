...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/delta3classic.md
title: Staaten für DELTA3CLASSIC
hash: DJz2NCUI0AGM7EeljDm0Tgtz80Kljln8K0d62W311UE=
---
# Staaten für DELTA3CLASSIC
...
| ---------------------------------------------- | :-: | :---: | :-----: | :---: | -------------------------------------------------- |
| plugInInfoPv2Amp                               |  0  |   15  |    A    |   1   | Steckerinformationen PV2-Verstärker                |
| plugInInfoDcp2Amp                              |  0  |   15  |    A    |   1   | Steckerinformationen DCP2-Verstärker               |
| plugInInfoDcp2Vol                              |  0  |   65  |    V    |   1   | Steckerinformationen PV2-Spannung                  |
| plugInInfo\_12vVol                             |  0  |   16  |    V    |   1   | Steckerinformationen 12V Lautstärke                |
| plugInInfo\_12vAmp                             |  0  |   15  |    A    |   1   | Steckerinformationen 12V Ampere                    |
| llcBatVol                                      |  0  |   60  |    V    |   1   | llc bat vol                                        |
| llcBatCur                                      |  0  |   15  |    A    |   1   | LLC-Batterieverstärker                             |
...
| plugInInfoBmsVol                               |  0  |   60  |    V    |   1   | Steckerinformationen Hauptbatterie Lautstärke      |
| PlugInInfoAcInAmp                              |  0  |   10  |    A    |   1   | Steckerinformationen Wechselstromeingang Ampere    |
| plugInInfoAcOutAmp                             |  0  |   10  |    A    |   1   | Steckerinformationen, Netzausgangsverstärker       |
| bmsBattVol                                     |  0  |   60  |    V    |   1   | Hauptbatterie Batterievolumen                      |
| bmsBattAmp                                     | -80 |   80  |    A    |   1   | Hauptbatterie-Bat-Verstärker                       |
| bmsFullCap                                     |  0  | 20000 |   mAh   |   1   | Hauptbatterie voll                                 |
| bmsRemainCap                                   |  0  | 20000 |   mAh   |   1   | Hauptbatterie bleibt Kappe                         |
| bmsMinCellVol                                  |  0  |   5   |    V    | 0.001 | Mindestspannung der Hauptbatterie                  |
| bmsMaxCellVol                                  |  0  |   5   |    V    | 0.001 | Maximale Zellenkapazität der Hauptbatterie         |
| cmsBattVol                                     |  0  |   60  |    V    |   1   | cms batt vol                                       |
| cmsBattAmp                                     | -80 |   80  |    A    |   1   | CMS-Batterieverstärker                             |
| cmsChgReqVol                                   |  0  |   60  |    V    |   1   | cms chg req vol                                    |
| cmsChgReqAmp                                   |  0  |   60  |    A    |   1   | CMS-Anforderungsverstärker                         |
...
| PlugInInfoPvAmp                                |  0  |   15  |    A    |   1   | Anschlussinformationen PV-Verstärker               |
| plugInInfoDcpVol                               |  0  |   60  |    V    |   1   | Steckerinfo DCP-Lautstärke                         |
| plugInInfoDcpAmp                               |  0  |   15  |    A    |   1   | Steckerinformationen DCP-Verstärker                |

### Array

| Zustand                | Name                            |
| ---------------------- | ------------------------------- |
| plugInInfo\_12vAmpList | 12V Ampere-Liste                |
| plugInInfoAcOutAmpList | Liste der AC-Ausgangsverstärker |
| tempList               | Temperaturen                    |
...
| bmsBalState         |     Hauptbatterie-Balancezustand    | {0:OK?} |
| bmsAlmState         |      Hauptbatterie-Alarmzustand     | {0:OK?} |
| bmsProState         |     Hauptbatterie-Profi-Zustand     | {0:OK?} |
| bmsFltState         |      Hauptbatterie-Flat-Zustand     | {0:OK?} |
| bmsAlmState\_2      |     Hauptbatterie-ALM-Status\_2     | {0:OK?} |
| bmsProState\_2      |     Hauptbatterie Pro Status\_2     | {0:OK?} |
...
| plugInInfoPv2ChgMaxList            | Plugin-Info PV2-Ladeliste                                   |
| bmsErrCode                         | Hauptbatterie-Fehlercode                                    |
| drahtloseKoordinateEntwicklerliste | Liste der drahtlosen Koordinatengeräte                      |
| kabelloser Öl-Selbststart          | drahtloser Öl-Selbststart                                   |
| bypassOutDisable                   | Umgehung der Deaktivierung                                  |
| plugInInfoAcInChgHalPowMax         | Steckerinformationen AC Eingang Ladezeit Halbe Leistung Max |
...
| multiBpChgDsgMode                  | Multi-BP-Änderungs-DSG-Modus                                |
| StromschutzPort auswählen          | Auswahl des Stromschutzanschlusses                          |
...
| powOutSumW                        |   0   |  1200 |    W    |   1  | Gesamtausgangsleistung                              |
...
| powGetTypec3                      |   0   |  4000 |    W    |   1  | Echtzeit-Leistungsaufnahme des Typ-C-Anschlusses 3  |
...
| plugInInfoPv2ChgVolMax            |   0   |   61  |    V    |   1  | Steckerinfo PV2-Laständerung Max                    |
...
| ----------------------- | :-: | :--: | :-----: | :------: | ------------------------------------------------------------- | --------------------------------------- |
| LCD-Beleuchtung         |  0  |  100 |    %    | 0.390625 | Bildschirmhelligkeit                                          | {dest:2,cmdFunc:254,cmdId:17,dataLen:2} |
...
| plugInInfoAcInChgMode   |  0  |   2  |         |     1    | Informationen zum Netzteil im Lademodus                       | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| plugInInfoAcInChgPowMax | 100 | 1500 |    W    |     1    | Maximale AC-Eingangsleistung zum Laden                        | {dest:2,cmdFunc:254,cmdId:17,dataLen:7} |
...
| cmsOilOnSoc             |  10 |  30  |    %    |     1    | SOC für den automatischen Start des Smart Generators          | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
...
| flowInfoTypec3               |                   Status des Typ-C-Anschlusses 3                   | {0:aus,2:ein}                                          |
...
| upsAlarm                     |                              UPS-Alarm                             | {0:OK?,1:Fehler}                                       |
| pcsFanErrFlag                |                          pcs fan err flag                          | {0:OK?,1:Fehler}                                       |
| llcHvLvFlag                  |                           llc Hv Lv Flag                           | {0:OK?,1:Fehler}                                       |
| Sturmmusterkonfliktflagge    |                     Sturmmuster-Konfliktflagge                     | {0:OK?,1:Fehler}                                       |
| bypassOutDisableConflictFlag |                        Konfliktflag umgehen                        | {0:OK?,1:Fehler}                                       |
| updateBanFlag                |                      Bannflagge aktualisieren                      | {0:OK?,1:Fehler}                                       |
| plugInInfoPvWeakSourceFlag   |               Plug-in-Info PV Schwache-Quellen-Flagge              | {0:OK?,1:Fehler}                                       |
| Stromausfall-Aktiv-Flag      |                         Stromausfälle aktiv                        | {0:OK?,1:Fehler}                                       |
...
| flowInfoAc2Out               |                 Durchflussinformationen AC2 Ausgang                | {0:OK?}                                                |
...
| Liste der Stromausfälle        | Liste der Stromausfälle                |
| powGet\_12vList                | pow Get 12V Liste                      |
| powGetAcOutList                | Liste der herausnehmbaren Klimaanlagen |
| Zeitzonenänderungsliste        | Zeitzonenänderungsliste                |
| Energiestrategie-Betriebsmodus | Energiestrategie-Betriebsmodus         |
...
| cfgUsbOpen      | aus |  An | USB-Ausgangsschalter | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |