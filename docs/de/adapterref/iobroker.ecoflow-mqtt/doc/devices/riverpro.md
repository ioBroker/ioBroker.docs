...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/riverpro.md
title: Staaten für RIVERPRO
hash: gnqblabEv1fO7ctU8qdLm9uYYlcCakHCUMkAMzjo0yA=
---
# Staaten für RIVERPRO
...
| tagChgVol       |  0  |  100  |    V    |  0.001 | Zielladespannung                   |
...
| bqSysStatReq | BQ Hardware-Schutzregister                     |
...
| cfgAcChgModeFlg |           AC-Lademodus-Flag          | {0:?,1:?}                                                                                                                       |
| cfgFanMode      |              Lüftermodus             | {0:deaktiviert,1:Stufe 1,2:Stufe 2,3:Stufe 3}                                                                                   |
...
| inTemp                   |  0  |  80  |    °C   |   1   | Wechselrichtertemperatur                     |
| invInAmp                 |  0  |  13  |    A    | 0.001 | Wechselrichter-Eingangsstrom                 |
| invInFreq                |  0  |  62  |    Hz   |   1   | Wechselrichter-Eingangsfrequenz              |
| invInVol                 |  0  |  250 |    V    | 0.001 | Eingangsspannung des Wechselrichters         |
...
| Autoschalter |   aus  |   An  | Kfz-Ladeschalter | {from:Android,operateType:TCP,id:689699572,lang:en-us,params:{id:34,enabled:1},version:1.0} |
...
| WattsInSum         |  0  |   660   |    W    |    1   | Gesamteingangsleistung                                                                                    |
| Watt-Ausgangssumme |  0  |   4000  |    W    |    1   | Gesamtausgangsleistung                                                                                    |
| LED-Watt           |  0  |   100   |    W    |   0.1  | LED-Ausgangsleistung                                                                                      |
| typecTemp          |  0  |    80   |    °C   |    1   | Temperatur vom Typ C                                                                                      |
| Typ C Watt         |  0  |   500   |    W    |    1   | Ausgangsleistung Typ C                                                                                    |
| USB 3 Watt         |  0  |   500   |    W    |   0.1  | Übliche USB3-Ausgangsleistung                                                                             |
...
| --------------- | :-----------------: | --------------- |
| Fehlercode      | Globaler Fehlercode | {0:OK?}         |
| geführter Staat |     LED-Zustand     | {0:aus?,1:ein?} |
