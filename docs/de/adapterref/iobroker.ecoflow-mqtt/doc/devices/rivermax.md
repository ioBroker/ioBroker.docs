...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/rivermax.md
title: Bundesstaaten für RIVERMAX
hash: K1Nm3X8b8VSrE+OJB+3fEz5hVjrjcFRBro4hVsZiIto=
---
# Bundesstaaten für RIVERMAX
...
| Zustand            | Min |   Max   | Einheit |  Mult  | Name                                                                                                      |
| ------------------ | :-: | :-----: | :-----: | :----: | --------------------------------------------------------------------------------------------------------- |
| WattsInSum         |  0  |   500   |    W    |    1   | Gesamteingangsleistung                                                                                    |
