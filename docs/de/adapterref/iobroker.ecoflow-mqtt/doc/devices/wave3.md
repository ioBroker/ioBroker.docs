...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/wave3.md
title: Staaten für WAVE3
...
| temporäre Haustierpflegewarnung  | Warnung zur Haustierpflege       |
| powerOffDelaySet                 | powerOffDelaySet                 |
| Verbleibende Abschaltverzögerung | Verbleibende Abschaltverzögerung |
...
| currentTimeTaskV2Item      |   0   |   60  |    A    |   1  | Aktuelle Zeitaufgabe v2 Element                     |
...
| plugInInfoPvDcAmpMax       |   0   |   60  |    A    |   1  | Steckerinformationen PV DC Ampere max.              |
...
| Umgebungstemperatur        |   0   | n / A |    °C   |   1  | Einlasstemperatur?                                  |
| humiAmbient                |   0   | n / A |    %    |   1  | Luftfeuchtigkeit?                                   |
| tempIndoorSupplyAir        |   0   | n / A |    °C   |   1  | Auslasstemperatur?                                  |
| Kondensatwasserstand       |   0   |  100  |    %    |   1  | Kondensatwasserstand                                |
| powGetSelfConsume          |   0   | n / A |    W    |   1  | Eigenverbrauch an Energie                           |
...
| Wellenbetriebsmodus        |                         Wellenbetriebsmodus                        | {0:NULL,1:KÜHLUNG,2:HEIZUNG,3:BELÜFTUNG,4:ENTFEUCHTUNG,5:THERMOSTATISCH} |
| Entwässerung               |                            Entwässerung                            | {0:aus?,1:ein?}                                                          |
| Entwässerungsmodus         |                         Entwässerungsmodus                         | {0:aus?,1:ein?}                                                          |
| Stimmungslichtmodus        |                         Stimmungslichtmodus                        | {0:aus?,1:ein?,2:gedimmt?}                                               |
| lcdShowTempType            |                           lcdShowTempType                          | {0:aus?,1:ein?}                                                          |
| enPetCare                  |                              enPetCare                             | {0:aus,1:ein}                                                            |
| userTempUnit               |                          Temperatureinheit                         | {0: nicht eingestellt?,1:°C (Celsius),2:°F (Fahrenheit)}                 |
| Haustierpflegewarnung      |                        Haustierpflegewarnung                       | {0:aus?,1:ein?}                                                          |
...
| Zustand        | Name                          |
| -------------- | ----------------------------- |
| waveModeInfo   | Informationen zum Wellenmodus |
| devErrcodeList | Liste der Gerätefehlercodes   |