...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/rapidpro320.md
title: Staaten für RAPIDPRO320
hash: u9vZ7KEMN1F6PSrk+hdeyHrZilgcDGTfMzqnlyJuauQ=
---
# Staaten für RAPIDPRO320
...
| sysStatus             |                      Systemstatus                     | {0: Gerät aus, 1: Gerät an, 2: Gerät im Standby-Modus} |
| cmsChgDsgState        |                  Lade-/Entladestatus                  | {0: Nicht laden oder entladen, 1: Entladen, 2: Laden}  |
| utcSetMode            |                   UTC-Einstellmodus                   | {0:OK?}                                                |
| batteryMaintainModel  |                 Batteriewartungsmodell                | {0:0?,1:1?}                                            |
| chargeOptCtrlEnable   |                Ladeoptionen aktivieren                | {0:0?,1:1?,2:2?}                                       |
| chargeOptState        |                    Ladung Opt State                   | {0:0?,1:1?}                                            |
| tempSmartCtrlEnable   |          temporäre Smart-Steuerung aktivieren         | {0:0?,1:1?,2:2?}                                       |
| lowPowerDsgCtrlEnable | niedrige USB-Stromversorgung Dsg-Steuerung aktivieren | {0:0?,1:1?,2:2?}                                       |

### Nummer

| Zustand                        |  Min  |  Max  | Einheit | Mult | Name                                        |
| ------------------------------ | :---: | :---: | :-----: | :--: | ------------------------------------------- |
| powInSumW                      |  -400 |  400  |    W    |   1  | Gesamteingangsleistung                      |
| powOutSumW                     |  -400 |  400  |    W    |   1  | Gesamtausgangsleistung                      |
...
| usbTypeA1DisplayInfo\_usbPow   |  -150 |  150  |    W    |   1  | Stromversorgung des USB-A-Anschlusses       |
| usbTypeA1DisplayInfo\_usbVolt  |  -50  |   50  |    V    |   1  | Spannung des USB-A-Anschlusses              |
| usbTypeA1DisplayInfo\_usbAmp   |  -10  |   10  |    A    |   1  | Stromstärke des USB-A-Anschlusses           |
| usbTypec1DisplayInfo\_usbPow   |  -150 |  150  |    W    |   1  | Stromversorgung des USB-1-Anschlusses       |
| usbTypec1DisplayInfo\_usbVolt  |  -50  |   50  |    V    |   1  | Spannung des USB-1-Anschlusses              |
| usbTypec1DisplayInfo\_usbAmp   |  -10  |   10  |    A    |   1  | Stromstärke des USB-1-Anschlusses           |
| usbTypec2DisplayInfo\_usbPow   |  -150 |  150  |    W    |   1  | Stromversorgung des USB 2-Anschlusses       |
| usbTypec2DisplayInfo\_usbVolt  |  -50  |   50  |    V    |   1  | Spannung des USB 2-Anschlusses              |
| usbTypec2DisplayInfo\_usbAmp   |  -10  |   10  |    A    |   1  | Stromstärke des USB 2-Anschlusses           |
| usbTypec3DisplayInfo\_usbPow   |  -150 |  150  |    W    |   1  | Stromversorgung des USB 3-Anschlusses       |
| usbTypec3DisplayInfo\_usbVolt  |  -50  |   50  |    V    |   1  | Spannung des USB 3-Anschlusses              |
| usbTypec3DisplayInfo\_usbAmp   |  -10  |   10  |    A    |   1  | Stromstärke des USB 3-Anschlusses           |
| usbTypec4DisplayInfo\_usbPow   |  -150 |  150  |    W    |   1  | Stromversorgung des USB 4-Anschlusses       |
| usbTypec4DisplayInfo\_usbVolt  |  -50  |   50  |    V    |   1  | Spannung des USB 4-Anschlusses              |
| usbTypec4DisplayInfo\_usbAmp   |  -10  |   10  |    A    |   1  | Stromstärke des USB 4-Anschlusses           |
| pogopin\_1DisplayInfo\_usbPow  |  -350 |  350  |    W    |   1  | Die Macht des Pogopins                      |
| pogopin\_1DisplayInfo\_usbVolt |  -50  |   50  |    V    |   1  | Spannung des Pogopins                       |
| pogopin\_1DisplayInfo\_usbAmp  |  -20  |   20  |    A    |   1  | Strom des Pogopins                          |
| typec3MaxAllowUsbPow           |   0   |  100  |    %    |   1  | Typ C 3 Max Zulässige USB-Leistung          |
| typec4MaxAllowUsbPow           |   0   |  100  |    %    |   1  | Typ C 4 Max. Zulässige USB-Leistung         |
| typec2MaxAllowUsbPow           |   0   |  100  |    %    |   1  | Typ C 2 Max. Zulässige USB-Leistung         |
| typec1MaxAllowUsbPow           |   0   |  100  |    %    |   1  | Typ C 1 Max. zulässige USB-Leistung         |
| cmsBattTemp                    |  -20  |   80  |    °C   |   1  | Batterietemperatur                          |
| cmsBattFullCap                 |   0   | 40000 |   mAh   |   1  | Hauptbatterie voll                          |
| cmsBattDesignCap               |   0   | 40000 |   mAh   |   1  | Hauptbatterie voll                          |
| cmsBattRemainCap               |   0   | 40000 |   mAh   |   1  | Hauptbatterie voll                          |
| UTC-Zeitzone                   | -1200 |  1200 |         |   1  | UTC-Zeitzone                                |
| cmsBattCycleNum                |   0   |  6000 |         |   1  | cms Batt Anzahl der Zyklen                  |
| cmsEnergyOutSum                |   0   | n / A |    Wh   |   1  | Summe der Energieverbrauchsausgaben des CMS |
| cmsEnergyInSum                 |   0   | n / A |    Wh   |   1  | cms Energie in Summe                        |
...
| Bildschirmschoner-Schalter aktivieren | Bildschirmschoner-Schalter aktivieren |
| BildschirmschonerAnzeigezeiten        | Bildschirmschoner-Anzeigezeiten       |
| Bildschirmschoner-Anzeigeindex        | Bildschirmschoner-Anzeigeindex        |
| Bildschirmuhrschalter aktivieren      | Bildschirmuhr-Schalter aktivieren     |
| BildschirmuhrAnzeigezeiten            | Bildschirm Uhranzeige Zeiten          |
| Bildschirmuhranzeigeformat            | Bildschirmuhranzeigeformat            |
| BildschirmThemeAnzeigeIndex           | Bildschirm-Themenanzeigeindex         |
| Batteriewartungszyklusnummer          | Batteriewartungszyklus Nr.            |
| BildschirmuhrAnzeigeZeitenLaden       | Bildschirm Uhranzeige Ladezeiten      |
| Bildschirmvorschau                    | PicP-Bildschirmrezension              |
| screenSourceFileRecvSta               | Bildschirm Quelldatei Empfangen Sta   |
| screenSourceRecvProgress              | Bildschirm SourceR ecv Fortschritt    |
...
| ------------------------------------ | :-: | :-: | ----------------------------- | --------------------------------------- |
| typec1PortEnable                     | aus |  An | Typ C 1 Port aktivieren       | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| typec2PortEnable                     | aus |  An | Typ C 2 Port aktivieren       | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| typec3PortEnable                     | aus |  An | Typ C 3 Port aktivieren       | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| typec4PortEnable                     | aus |  An | Typ C 4 Port aktivieren       | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| pogopinPortEnable                    | aus |  An | Pogopin-Port aktivieren       | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |
| Alarmschalter mit niedriger Leistung | aus |  An | Niedrigbatterie-Alarmschalter | {dest:2,cmdFunc:254,cmdId:17,dataLen:3} |