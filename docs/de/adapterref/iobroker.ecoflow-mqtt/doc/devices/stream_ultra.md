...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.ecoflow-mqtt/doc/devices/stream_ultra.md
title: Zustände für STREAM_ULTRA
hash: Nmbr5xdNpYV23VFrpUDIXyeRw5RWBQBtH4c+1b22oAU=
---
# Zustände für STREAM\_ULTRA
...
| --------- | :---: | :--: | :-----: | :--: | ------------------------------------ |
| startMin1 | -1440 | 1440 |   min   |   1  | Startminuten Aufgabe Nr. 1           |
| endMin1   | -1440 | 1440 |   min   |   1  | Aufgabe Nr. 1: Abschluss der Minuten |

### Ebene

| Zustand    | Min | Max | Einheit | Mult | Name                            | cmd                                                                                                                                                                                                                           |
| ---------- | :-: | :-: | :-----: | :--: | ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| LoadPower1 |  0  | 800 |    W    |   1  | Lastausgangsleistungsaufgabe #1 | {src:32,dest:2,dSrc:1,dDest:1,cmdFunc:254,cmdId:17,dataLen:9,productId:56,version:3,payloadVer:1,pdata:{cfgUtcTime:6,cfg\_feed\_grid\_mode\_pow\_limit:169,cfg\_day\_resident\_load\_list:{startMin:1,endMin:2,loadPower:3}}} |
...
| cmsBattPowOutMax             |   0   |  8000 |    W    |   1  | CMS-Batterieleistung maximal                               |
| cmsBattPowInMax              |   0   |  8000 |    W    |   1  | CMS-Batterieleistung in maximaler                          |
| cmsBattFullEnergy            |   0   |  1920 |    Wh   |   1  | CMS-Batterie mit voller Energie                            |
...
| powSysAcOutMax               |   0   |  4000 |    W    |   1  | maximale Ausgangsleistung des Stromversorgungssystems (AC) |
...
| sysGridConnectionPower       |   0   |  2500 |    W    |   1  | Systemnetzanschluss                                        |
| powGetPv3                    |   0   |  600  |    W    |   1  | Pow erhält PV3                                             |
| powGetPv4                    |   0   |  600  |    W    |   1  | Pow erhält PV4                                             |
| plugInInfoPvVol              |   0   |   60  |    V    |   1  | Plug-in-Info PV1 Lautstärke                                |
| PlugInInfoPvAmp              |   0   |   20  |    A    |   1  | Steckerinformationen PV1 Strom                             |
| plugInInfoPv2Vol             |   0   |   60  |    V    |   1  | Plug-in-Info PV2-Lautstärke                                |
| plugInInfoPv2Amp             |   0   |   20  |    A    |   1  | Steckerinformationen PV2 Strom                             |
| plugInInfoPv3Vol             |   0   |   60  |    V    |   1  | Plug-in-Info PV3-Lautstärke                                |
| plugInInfoPv3Amp             |   0   |   20  |    A    |   1  | Steckerinformationen PV3 Strom                             |
| plugInInfoPv4Vol             |   0   |   60  |    V    |   1  | Plug-in-Info PV4-Lautstärke                                |
| plugInInfoPv4Amp             |   0   |   20  |    A    |   1  | Steckerinformationen PV4 Strom                             |
| powGetSysLoadFromPv          |   0   |  2000 |    W    |   1  | Stromversorgung bezieht Systemlast von PV                  |
| powGetSysLoadFromBp          |   0   |  4000 |    W    |   1  | Pow erhält GYS-Ladung von BP                               |
| powGetSysLoadFromGrid        |   0   | 10000 |    W    |   1  | pow erhält Systemlast vom Netz                             |
| powSysAcInMax                |   0   |  4000 |    W    |   1  | pow Sys Ac In Max                                          |
| Steckdosenleistung messen    |   0   |  4000 |    W    |   1  | Steckdose Leistungsmessung                                 |
| powGetSchuko1                |   0   |  2100 |    W    |   1  | Steckdose 1                                                |
| powGetSchuko2                |   0   |  2100 |    W    |   1  | Steckdose 2                                                |
| Stromschienenleistungsgrenze |   0   |  2300 |    W    |   1  | Stromschienen-Leistungsbegrenzung                          |
| maxInvInput                  |   0   |  2000 |    W    |   1  | max Inv Input                                              |
| maxInvOutput                 |   0   |  2000 |    W    |   1  | max Inv Output                                             |
| maxBpInput                   |   0   |  2000 |    W    |   1  | max Bp Eingangssignal                                      |
| maxBpOutput                  |   0   |  2000 |    W    |   1  | max Bp Ausgangsleistung                                    |
| feedGridModePowLimit         |   0   |  1500 |    W    |   1  | Netzmodus Leistungsgrenze                                  |
| feedGridModePowMax           |   0   |  1500 |    W    |   1  | Netzmodus für Zufuhr Pw Max                                |
| Helligkeit                   |   0   |  100  |    %    |   1  | Helligkeit                                                 |
...
| systemGroupId         | Systemgruppen-ID        |
| seriesConnectDeviceId | Serie Connect Geräte-ID |
...
| bmsChgDsgState            | Lade-/Entladestatus der Hauptbatterie | {0: wird weder geladen noch entladen, 1: wird entladen, 2: wird geladen}                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| plugInInfoPv3Flag         |        Plug-in-Info PV3-Flagge        | {0:OK?}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| plugInInfoPv4Flag         |        Plug-in-Info-PV4-Flagge        | {0:OK?}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Relay1EinAus              |            Relais 1 Status            | {0:aus?,1:ein}                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| relay4OnOff               |            Relais 4 Status            | {0:aus?,1:ein}                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| feedGridMode              |            Speisenetzmodus            | {1:online?}                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| bmsBattHeating            |       BMS-Batterieheizungsstatus      | {0:aus?,1:ein}                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| StormPatternEnable        |         Sturmmuster aktivieren        | {0:aus?,1:ein?}                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Sturmmuster Offene Flagge |       Sturmmuster offene Flagge       | {0:aus?,1:ein?}                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| gridConnectionSta         |         Netzverbindungsstation        | {0:GRD\_STA\_NO\_VAILD,1:GRID\_IN,2:GRID\_NOT\_ONLINE,3:FEED\_GRID}                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Energie-Backup-Status     |         Energie-Backup-Zustand        | {0:OK?}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| verteilterGerätestatus    |        verteilter Gerätestatus        | {0:Wahl,1:Meister,2:Sklave}                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| seriesConnectDeviceStatus |      Verbindungsstatus der Serie      | {0:Wahl,1:Meister,2:Sklave}                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| devCtrlStatus             |      Entwickler-Steuerungsstatus      | {0:nicht ok?,1:ok?}                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| updateBanFlag             |        Bannflagge aktualisieren       | {0: nicht gesetzt?,1: gesetzt?}                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

### Ebene

| Zustand                   | Min | Max | Einheit | Mult | Name                                   | cmd                                                                                                                                                  |
| ------------------------- | :-: | :-: | :-----: | :--: | -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| cmsMaxChgSoc              |  50 | 100 |    %    |   1  | Ladelimit                              | {src:32,dest:2,dSrc:1,dDest:1,cmdFunc:254,cmdId:17,dataLen:12,productId:56,version:3,payloadVer:1,pdata:{cfgUtcTime:6,cmsMaxChgSoc:33}}              |
| cmsMinDsgSoc              |  0  |  30 |    %    |   1  | Abflussgrenze                          | {src:32,dest:2,dSrc:1,dDest:1,cmdFunc:254,cmdId:17,dataLen:12,productId:56,version:3,payloadVer:1,pdata:{cfgUtcTime:6,cmsMinDsgSoc:34}}              |
...
| powConsumptionMeasurement |  1  |  2  |         |   1  | Pulververbrauchsmessung und Handhabung | {src:32,dest:2,dSrc:1,dDest:1,cmdFunc:254,cmdId:17,dataLen:9,productId:56,version:3,payloadVer:1,pdata:{cfgUtcTime:6,powConsumptionMeasurement:239}} |

### schalten

| Zustand      | aus |  An | Name                 | cmd                                                                                                                                    |
| ------------ | :-: | :-: | -------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| relay2OnOff  | aus |  An | Relais AC Ausgang #1 | {src:32,dest:2,dSrc:1,dDest:1,cmdFunc:254,cmdId:17,dataLen:9,productId:56,version:3,payloadVer:1,pdata:{cfgUtcTime:6,relay2Onoff:380}} |
| relay3EinAus | aus |  An | Relais AC Ausgang #2 | {src:32,dest:2,dSrc:1,dDest:1,cmdFunc:254,cmdId:17,dataLen:9,productId:56,version:3,payloadVer:1,pdata:{cfgUtcTime:6,relay3Onoff:380}} |
...
| Ampere                   |  0  |   40   |    A    | 0.0001 | Ampere                                 |
| Temperatur               |  0  |   90   |    °C   |    1   | Temperatur                             |
| designCap                |  0  | 100000 |   mAh   |    1   | Designkappe                            |
| Restkapital              |  0  | 100000 |   mAh   |    1   | Restobergrenze                         |
| volle Kapazität          |  0  | 100000 |   mAh   |    1   | volle Kapazität                        |
