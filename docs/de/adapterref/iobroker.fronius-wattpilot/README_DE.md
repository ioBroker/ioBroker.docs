...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.fronius-wattpilot/README_DE.md
...
[Zur englischen Version der README-Datei](/#/docs/adapterref/iobroker.fronius-wattpilot/README_DE.md)

## Was ist dieser Adapter?

Dieser Adapter integriert Ihr Fronius Wattpilot EV-Ladegerät mit ioBroker und ermöglicht es Ihnen, Ihre Ladestation zu überwachen und zu steuern. Der Wattpilot ist eine intelligente Ladelösung für Elektrofahrzeuge, die in Ihr Smart-Home-System integriert werden kann.
...
- **Router-Methode** : Überprüfen Sie die Weboberfläche Ihres Routers für angeschlossene Geräte
...
- Geben Sie Ihrem Wattpilot- **Passwort** ein
- Konfigurieren Sie andere Einstellungen je nach Bedarf
...
- Den Wattpilot-Ladestrom wird automatisch basierend auf überschüssiger Solarenergie angepasst
...
- **Letzter Ausgleich** : Ladestrom basierend auf Haushalts-Stromverbrauch anpassen
...
Copyright © 2024 tim2zg <tim2zg@protonmail.com>
