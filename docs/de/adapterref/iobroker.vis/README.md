...
- `/` - Teilen. Das Argument muss in Klammern stehen, z. B. „/(0,5)“. In diesem Beispiel dividieren wir den Wert durch 0,5.
- `%` – Modulo. Das Argument muss in Klammern stehen, z. B. „%(5)“. In diesem Beispiel nehmen wir Modulo von 5.
- „round“ – den Wert runden.
- „round(N)“ – runden Sie den Wert mit N Stellen nach dem Punkt ab, z. B. 34.678;round(1) => 34.7
...
* „Aktualisieren“ – Laden Sie die Vis neu, beispielsweise nachdem das Projekt geändert wurde, um es in allen Browsern neu zu laden.
