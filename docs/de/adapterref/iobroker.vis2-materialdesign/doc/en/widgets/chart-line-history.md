...
- **History-Adapter-Instanz:** Quelle aller Zeitreihen.
- **Anzuzeigendes Zeitintervall:** gleitendes Fenster, das zum aktuellen Zeitpunkt endet.
- **Kontrollintervall mit Objekt:** überschreibt das feste Fenster zur Laufzeit.
- **Aktualisierung:** in Echtzeit, in einem festen Intervall oder durch ein Triggerobjekt.
- **Timeout für Diagramme:** Maximale Wartezeit für die Abfrage des Verlaufs in Sekunden.

Diese Optionen befinden sich in der Gruppe **„Allgemein“** . Die Benutzeroberfläche des Editors verwendet die Systemsprache von ioBroker, daher sind die Screenshots auf Deutsch.
...
## Datensätze und Verlaufsanfrage

Jede indizierte Gruppe beschreibt einen aufgezeichneten Zustand und dessen Abfrage. Darstellungsoptionen mit demselben Index gehören zu dieser Zeitreihe. Ohne benutzerdefinierten Legendentext wird die Objekt-ID angezeigt.
...
Die Stile **Classic** (links) und **Material 3** (rechts) nebeneinander, siehe [Designstil](/#/docs/adapterref/iobroker.vis2-materialdesign/doc/en/README.md#design-style) : die einfache Linie, Wertbezeichnungen, gestufte Linien, eine Füllfarbe, ohne Legende und innerhalb einer Karte.

<img src="../../media/vis2_chart_line_history_styles.png" alt="Line history chart in the Classic and the Material 3 style">

Die gleichen Widgets mit aktiviertem Dunkelmodus:
