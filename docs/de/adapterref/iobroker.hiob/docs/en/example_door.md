...
- `door_states` Die zu überwachenden Zustände müssen nun hier hinzugefügt und benannt werden. Diese Objekte werden dann unter alias.0.\<alias\_object\_name> erstellt. Sollte ein Objekt geändert oder gelöscht werden müssen, nehmen Sie die Änderung bitte in Blockly vor. Objekte, die hier nicht eingefügt werden, werden automatisch um 14:00 Uhr überprüft und können gelöscht werden. Diese Überprüfung kann weiter unten eingerichtet werden. Die Zustände können nur die Werte 0, 1, wahr oder falsch annehmen!
...
- `emoji_open` Ausgaben beim Öffnen eines Fensters.
- `emoji_closed` Ausgaben beim Schließen eines Fensters.
...
![Beispiel\_Türschirm\_erstellen.png](img/example_door/example_door_screen_create.png)</br>![example\_door\_screen\_create\_icon.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_door/example_door_screen_create_icon.png)
