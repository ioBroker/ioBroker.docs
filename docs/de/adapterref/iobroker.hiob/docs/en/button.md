...
### Ein Zustand kann mithilfe einer Schaltfläche auf „true“ gesetzt werden.

- Wischen Sie nach links, um ein Widget zu löschen.
- Drücken Sie das Pluszeichen unten rechts.

![Knopf](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_template.png)

- Dropdown-Menü: auswählen`Button` Die
- Name: Name des Widgets
- Wert (optional): Im Widget anzuzeigender Text. Wenn nichts angegeben wird, wird der Name verwendet.
- Schaltflächentext (optional): Dieser Text wird auf der Schaltfläche angezeigt.

![Knopf](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button.png)

- Gerät: Wählen Sie den gewünschten Eintrag aus.

![Knopf](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button_device.png)

- Datenpunkt: Auswahl von Staaten aus der ausgewählten Liste.

![Knopf](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button_dp.png)
...
![Knopf](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_button_done.png)
