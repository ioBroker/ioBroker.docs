...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.hiob/docs/en/division.md
title: kein Titel
hash: fggbAZhTkJ6Kc/pZNJxV8fu93U/6tJA++IGS8ATc4I8=
---
...
### Trennlinien zwischen den Widgets

- Wischen Sie nach links, um ein Widget zu löschen.
- Drücken Sie das Pluszeichen unten rechts.

![Division](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_switch_done.png)

- Dropdown-Menü: Auswählen`Division Line` Die
- Name: Name des Widgets
- Dicke: Bitte geben Sie die Dicke an.
- Die Trennlinie kann nur einmal pro Bildschirm oder Gruppe verwendet werden.

![Division](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_division.png)
...
![Division](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_division_done.png)

- Fügen Sie nun das Widget einem Bildschirm hinzu.

![Division](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_create_division_screen.png)
