...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.hiob/docs/en/secureCon.md
...
Nachrichten zwischen Adapter und Mobiltelefon verschlüsseln?

## Beachten

Adapterversion mindestens 0.0.54
...
- Aktivieren Sie „Zertifikatverbindung verwenden“ und geben Sie die entsprechenden Pfade ein.
...
- In den App-Einstellungen das Kästchen „Sichere Verbindung verwenden“ aktivieren.
