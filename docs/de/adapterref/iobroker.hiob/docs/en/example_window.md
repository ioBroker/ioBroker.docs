...
- [Zurück](/#/docs/adapterref/iobroker.hiob/docs/en/example.md)
- [Widgets importieren](#import-widgets-json)
- [Blockly-Skript](#blockly-script---javascript-adapter--790)

# ioBroker-Statusfenster

### 1. Importiere das Blockly-Skript, aber starte es NICHT.

- [Blockly-Skript](#blockly-script---javascript-adapter--790)

### 2. Blockly-Einstellungen

- `window_states` Die zu überwachenden Zustände müssen nun hier hinzugefügt und benannt werden. Diese Objekte werden dann unter alias.0.\<alias\_object\_name> erstellt. Sollten Objekte geändert oder gelöscht werden müssen, nehmen Sie die entsprechenden Änderungen bitte in Blockly vor. Objekte, die hier nicht eingefügt werden, werden automatisch um 14:00 Uhr überprüft und können gelöscht werden. Diese Überprüfung kann weiter unten eingerichtet werden.
- `function_name` Der Name des Objektzustands, der unter erstellt wird`enum.function` Die
- `userdata_object_name` Der Name des Objekts (Kanals), das unter erstellt wird`0_userdata.0` Hier wird die Table\_Json-Datei für VIS oder die APP gespeichert und aktualisiert.
- `alias_object_name` Der Name des Objekts, das unter erstellt wird`alias.0` (Kanal). Hier werden dann die Zustände aus \<door\_states> neu erstellt und überwacht.
- `check_alias_object` Wenn diese Option aktiviert ist, werden die Zustände unter \<alias\_object\_name> täglich um 14:00 Uhr mit \<door\_states> abgeglichen. Falls Zustände vorhanden sind, die nicht in \<door\_states> eingetragen sind, wird dies als Warnung im Protokoll vermerkt. Diese können mit der Einstellung \<auto\_delete\_object> automatisch gelöscht werden.
- `auto_delete_object` Automatische Löschung zulassen (aktiviert).
- `debuggen` Gibt Protokolle vom Skript aus
- „emoji\_opened“ wird ausgegeben, wenn ein Fenster geöffnet ist.
...
- `value_for_tilted_2` Wert aus dem Zustand für geneigt (2 Optionen aufgrund verschiedener Hersteller) - Möglicher Wert: Boolescher Wert, Zahl oder Zeichenkette

![example\_window\_blockly\_settings.png](img/example_window/example_window_blockly_settings.png)</br>![example\_window\_blockly\_settings\_1.png](img/example_window/example_window_blockly_settings_1.png)</br>![example\_window\_blockly\_settings\_object.png](img/example_window/example_window_blockly_settings_object.png)</br>![example\_window\_blockly\_settings\_object\_add.png](img/example_window/example_window_blockly_settings_object_add.png)</br>![example\_window\_blockly\_settings\_object\_add\_1.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_window/example_window_blockly_settings_object_add_1.png)

### 4. Starte Blockly jetzt.

### 5. Enums erstellen

- Bundesstaat hinzufügen `0_userdata.0.<userdata_object_name>.`

![example\_window\_enum.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_window/example_window_enum.png)

### 6. Tabellen-Widget erstellen

- **Tabelle erstellen und Bundesland auswählen**
...
- **Spalten erstellen und hinzufügen**
...
![example\_window\_create\_table\_done.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_window/example_window_create_table_done.png)

- **Bildschirm erstellen**

![example\_window\_create\_screen.png](img/example_window/example_window_create_screen.png)</br>![example\_window\_create\_screen\_add\_icon.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_window/example_window_create_screen_add_icon.png)

- **Widget hinzufügen**

![example\_window\_create\_screnn\_add\_table.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_window/example_window_create_screnn_add_table.png)

### 7. Fertig

![example\_window\_screen\_done.png](img/example_window/example_window_screen_done.png)</br>![example\_window.gif](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_window/example_window.gif)

- [Zurück](/#/docs/adapterref/iobroker.hiob/docs/en/example.md)

# Widgets im JSON-Format importieren
