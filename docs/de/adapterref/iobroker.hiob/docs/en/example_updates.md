...
# ioBroker – Informationen, Neuigkeiten und Updates

### 1. Gewähren Sie dem Javascript-Adapter >= 7.9.0 die erforderlichen Rechte.

![example\_info\_js.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_js.png)

### 2. Blockly-Skript importieren

- `host_name` Name des Hosts (siehe Abbildung unten)

- `lang` Mögliche Sprachen en, de, ru, pt, nl, fr, it, es, pl, uk und zh-cn

- `channelname` Name des Kanals unter 0\_userdata.0

- `load_temp` Temperatur von der Himbeere

- `debugging` Aktiviert die Protokollausgabe

- [Blockly-Skript](#blockly-script---javascript-adapter--790) </br>![example\_info\_blockly.png](img/example_update/example_info_blockly.png)</br>![Beispielinfo\_Hostname.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_hostname.png)

### 3. Enum erstellen

- Erstelle ein neues Enum und füge die 3 Zustände hinzu.</br>![example\_info\_enum.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_enum.png)

### 4. Tabellen-Widget erstellen

- **Widget „Tabelle und Bundesland für Aktualisierungen auswählen“**
...
- **Kopiertabelle für Informationen und Neuigkeiten**

![example\_info\_create\_table\_update\_done.png](../en/img/example_update/example_info_create_table_update_done.png)</br>![example\_info\_create\_table\_update\_copy.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_create_table_update_copy.png)

- **Wählen Sie Tabelle und Bundesland für Informationen aus und passen Sie die Spalten an.**

![example\_info\_create\_table\_infos.png](../en/img/example_update/example_info_create_table_infos.png)</br>![example\_info\_create\_table\_infos\_columns.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_create_table_infos_columns.png)

- **Wählen Sie Tabelle und Bundesland für Nachrichten aus und passen Sie die Spalten an.**

![example\_info\_create\_table\_news.png](../en/img/example_update/example_info_create_table_news.png)</br>![example\_info\_create\_table\_news\_columns.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_create_table_news_columns.png)

- **Erstellte Widgets**

![example\_info\_create\_table\_done.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_create_table_done.png)

### 5. Bildschirm erstellen

- **Bildschirm erstellen**

![example\_info\_create\_screen.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_create_screen.png)

- **Erstelle 3 Gruppen für Informationen, Neuigkeiten und Updates.**

![example\_info\_create\_groups.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_create_groups.png)

- **Fügen Sie das Tabellen-Widget den jeweiligen Gruppen hinzu.**

![example\_info\_add\_infos.png](../en/img/example_update/example_info_add_infos.png)</br>![example\_info\_add\_news.png](../en/img/example_update/example_info_add_news.png)</br>![example\_info\_add\_updates.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info_add_updates.png)

### 6. Fertig

![example\_info\_done.png](../en/img/example_update/example_info_done.png)</br>![example\_info.gif](../../../../../en/adapterref/iobroker.hiob/docs/en/img/example_update/example_info.gif)
