...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.hiob/docs/en/backups.md
title: kein Titel
hash: NafXR71WkWqdI/1LKoohcwTTyzoGgmMhRXvCBplwr4Y=
---
...
## Backup erstellen`Config Sync`

- Hier können Sie Ihre Einstellungen (Widgets, Bildschirm und Gerät) in ioBroker speichern.
- Diese Backups können nur in ioBroker gelöscht werden. Löschen Sie den gewünschten Objektbaum vollständig unter „Einstellungen“.
- Drücken Sie das Pluszeichen unten rechts.

![app\_config\_sync.png](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_config_sync.png)

- Geben Sie den Namen des Sicherungsordners ein, der erstellt werden soll.

![app\_config\_sync\_create.png](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_config_sync_create.png)

- Klicken Sie anschließend auf Speichern.

![app\_config\_sync\_create\_done.png](../../../../../en/adapterref/iobroker.hiob/docs/de/img/app_config_sync_create_done.png)

- Drücken Sie nun die Schaltfläche „Einstellungen hochladen“, um eine Sicherungskopie zu erstellen. Andere Benutzer können diese Einstellungen anschließend beispielsweise über die Schaltfläche „Laden“ laden. Selbstverständlich sind mehrere Sicherungskopien möglich.

![config\_sync\_iobroker.png](../../../../../en/adapterref/iobroker.hiob/docs/en/img/config_sync_iobroker.png)
