...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.kecontact/kecontact.md
title: Programmablauf - ioBroker.kecontact
...
Der Adapter steuert eine KEBA KeContact P20/P30 (bzw. BMW i) Wallbox über **UDP** . Kernaufgabe: Den Ladestrom periodisch so regeln, dass das Fahrzeug bevorzugt aus PV-Überschuss (optional aus Batteriespeicher) geladen wird und dabei Netz- und Amperegrenzen eingehalten werden.
...
| `automatic.maxSoC`                                   | oberhalb dieses SoC nicht mehr geladen                    |
| `automatic.resetTargetSoC`                           | `targetSoC` nach zurück                                   |
