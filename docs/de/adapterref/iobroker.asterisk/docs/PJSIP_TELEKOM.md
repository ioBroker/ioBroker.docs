...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.asterisk/docs/PJSIP_TELEKOM.md
...
## Installation und Konfiguration von Asterisk beim Anbieter Telekom über PJSIP
...
1. IP-Adresse/Hostname des SIP-Servers: Geben Sie **tel.t-online.de** als Hostnamen ein.
2. Benutzername des SIP-Servers: Geben Sie hier Ihre Telefonnummer mit Ortsvorwahl ein (ohne Ländervorwahl!). Beispiel: 03047114711 (ohne Leerzeichen)
3. Passwort des SIP-Servers: Ihr Passwort muss folgendes Format haben **: PIN:ZUGANGSNUMMER-MITBENUTZERNUMMER** . Beispiel: 23457830:323127211711-0001
...
Sie müssen in der _Datei /etc/asterisk/rtp.conf_ die Werte _secret_ , _permit_ (Ihr Subnetz + Subnetzmaske) ändern.
...
Sie müssen in der Datei _/etc/asterisk/psip.conf_ einige Änderungen vornehmen. Ersetzen Sie bitte den Platzhalter **$mynumber** , ... wie beschrieben:

- **$mynumber** : meine Telefonnummer mit Vorwahl. Zum Beispiel: 03047114711 (ohne Leerzeichen)
- **$countrymynumber** : meine Telefonnummer mit Ländervorwahl. Zum Beispiel: +493047114711 (ohne Leerzeichen)
- **$Zugangsnummer** : Zugangsnummer wie 532496966969
- **$mitbenutzernr** : Mitbenutzernummer wie 0001
- **$pin** : Ihr Telekom-Passwort (persönliches Kennwort) wie 34242322

In der ioBroker Asterisk-Administration müssen Sie folgende Anpassungen vornehmen.

- Die IP-Adresse/der Hostname des SIP-Servers muss **tel.t-online.de** lauten.
- Der Benutzername des SIP-Servers muss **Telekom-Telefonnummer ($meinenummer)** (mit Vorwahl, ohne Leerzeichen, ohne Ländervorwahl) lauten.
- Das Passwort des SIP-Servers muss **pin:zugangsnummer-mitbenutzernr** Ihres Telekom-Kontos sein
