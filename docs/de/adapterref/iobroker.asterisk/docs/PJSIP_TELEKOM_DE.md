...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.asterisk/docs/PJSIP_TELEKOM_DE.md
...
1. IP/Hostname des SIP-Servers: Geben Sie hier **tel.t-online.de** als Hostname ein
2. Benutzername des SIP-Servers: Hinterlege Deine Telefonnummer mit Vorwahl (ohne Ländervorwahl!). Beispiel: 03047114711 (keine Leezeichen)
3. Passwort des SIP-Servers: Dein T-Online Passwort im folgenden Format **PIN:ZUGANGSNUMMER-MITBENUTZERNUMMER** . Beispiel: 23457830:323127211711-0001
...
- **$Zugangsnummer** : T-Online Zugangsnummer wie zB 532496966969
- **$mitbenutzernr** : Mitbenutzernummer wie zB 0001
- **$pin** : Dein Telekom / T-Online Passwort (persönliches Kennwort). Beispiel: 34242322
...
- Der Benutzername des SIP Servers ist Deine **Telekom-Telefonnummer ($mynumber)** (Mit Vorwahl, ohne Ländercode und ohne Leerzeichen)
- Das Passwort des SIP-Servers ist Ihre **PIN:Zugangsnummer-Mitbenutzernummer** Ihres Telekom-Kontos
