...
![NPM-Version](https://img.shields.io/npm/v/iobroker.message-queue.svg)
![Downloads](https://img.shields.io/npm/dm/iobroker.message-queue.svg)
![Anzahl der Installationen](https://iobroker.live/badges/message-queue-installed.svg)
