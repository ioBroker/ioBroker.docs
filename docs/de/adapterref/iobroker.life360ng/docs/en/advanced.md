...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/de/adapterref/iobroker.life360ng/docs/en/advanced.md
title: Registerkarte: Erweitert
hash: 6GF2XIO5SYyD3eHS2lQVgmIrd8JcP65nODk9nE2V3vE=
---
...
Die Registerkarte **„Erweitert“** enthält spezielle Einstellungen für Diagnose und Fehlersuche.

**Merkmale:**

- **Ausführliche Protokollierung:** Aktivieren Sie diese Option, um besonders detaillierte Protokollausgaben zu erhalten. Dies ist hilfreich, wenn Sie Probleme analysieren oder Fehler an den Entwickler melden möchten.

**Hinweis:** Erweiterte Protokolle sollten nur bei Bedarf aktiviert werden, da sie eine Menge zusätzlicher Informationen im ioBroker-Protokoll erzeugen können.