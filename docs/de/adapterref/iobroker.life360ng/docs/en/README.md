...
- [Allgemein](/#/docs/adapterref/iobroker.life360ng/docs/en/general.md)
- [Meine Orte](/#/docs/adapterref/iobroker.life360ng/docs/en/myplaces.md)
- [Integration](/#/docs/adapterref/iobroker.life360ng/docs/en/integration.md)
- [Logbuch](/#/docs/adapterref/iobroker.life360ng/docs/en/tracker.md)
- [Kartendarstellung](/#/docs/adapterref/iobroker.life360ng/docs/en/mapdisplay.md)
- [Benachrichtigungen](/#/docs/adapterref/iobroker.life360ng/docs/en/notifications.md)
- [Fortschrittlich](/#/docs/adapterref/iobroker.life360ng/docs/en/advanced.md)
- [Helfen](/#/docs/adapterref/iobroker.life360ng/docs/en/help.md)

Jeder Eintrag verlinkt auf eine eigene Unterseite mit detaillierten Erläuterungen zum entsprechenden Tab in der Adapterkonfiguration.

---

#### ioBroker-Anforderungen

1. nodejs 20.0 oder neuer
2. js-controller 6.0.11 (oder neuer)
3. Admin-Adapter 7.6.20 (oder neuer)
4. Web-Adapter (nur bei Verwendung des Logbuchs)