...
![NPM版本](https://img.shields.io/npm/v/iobroker.gotify.svg)
![下载](https://img.shields.io/npm/dm/iobroker.gotify.svg)
![安装数量（最新）](https://iobroker.live/badges/gotify-installed.svg)
![安装数量（稳定）](https://iobroker.live/badges/gotify-stable.svg)
![国家公共管理](https://nodei.co/npm/iobroker.gotify.png?downloads=true)

# IoBroker.gotify
**测试：** ![测试与发布](https://github.com/ThomasPohl/ioBroker.gotify/workflows/Test%20and%20Release/badge.svg)

## IoBroker 的 Gotify 适配器
从 [ioBroker](https://iobroker.net/) 至 [Gotify](https://gotify.net/) 发送推送通知
...
-   安装
- 为gotify-adapter创建一个新实例
- 输入您安装时的 URL
- 添加之前创建的令牌

＃＃ 用法
### 块状
使用 blockly 发送消息。只需将 Gotify 块添加到您的脚本中即可：![块状](../../../en/adapterref/iobroker.gotify/img/gotify.blockly.png)

如果您选择 Markdown 作为格式，则可以使用 [降价](https://guides.github.com/features/mastering-markdown/) 来格式化您的消息。
...
＃＃ 沟通
下图说明了 ioBroker 如何向您的智能手机发送推送通知。
![通讯图](../../../en/adapterref/iobroker.gotify/img/iobroker.gotify-communication.png)

ioBroker 和智能手机应用程序都使用 REST 连接到 Gotify 服务器。移动应用程序与 Gotify 服务器保持开放的 Websocket，以便能够接收新通知。

当 ioBroker 适配器想要推送通知时，它会向 Gotify 服务器发送 POST 请求。 Gotify 服务器负责将通知推送到客户端。
