...
editLink: https://github.com/ioBroker/ioBroker.docs/edit/master/docs/zh-cn/adapterref/iobroker.birthdays/blockly.md
...
# IoBroker.birthdays
## 示例（块状）
![块状示例](../../../en/adapterref/iobroker.birthdays/./img/blockly-example.png)
