...
---
ioBroker is a pure software solution to connect different IoT systems to one overall system. Accordingly, a control center (gateway / interface) is still required for each system to be able to integrate its devices.
...
!> As of May 2021, nodejs 12.x is recommended for ioBroker.
