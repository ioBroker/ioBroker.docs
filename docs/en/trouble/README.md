...
Please check the logs to see whether the relevant adapters have entries that are helpful at the point in time of the problem. Always puts logs and scripts or similar in spoilers.
