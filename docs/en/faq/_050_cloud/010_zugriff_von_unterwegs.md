...
title: no title
hash: JeFPBJN1lYP13tcynDYlryY4mYQt2drPXPbp/T9I1ds=
---
## How can I access ioBroker while on the go?

The simplest way is the [cloud adapter](/adapters/cloud) , the adapter for remote access. It establishes the connection from the inside out. Therefore, **no port needs to be opened in the router** , and a separate certificate is not required.
...
That's handled by a different adapter, the **IoT** adapter. In broad strokes:
