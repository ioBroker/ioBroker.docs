...
First, values must be recorded. Without recording, every diagram remains empty; see [Recording Values](/docs/tutorial/history.md) .
...
3. Add a first **line** and assign it the recorded data point. The source of the data is also specified, i.e., from...`history` ,`influxdb` or`sql` .
...
A finished diagram can be integrated into a [visualization](/docs/tutorial/viz.md) . Common widget sets offer a widget that displays a saved diagram; you simply specify which one.
...
The basics are now in place. What comes up regularly is updating: [installing updates](/docs/tutorial/updates.md) .