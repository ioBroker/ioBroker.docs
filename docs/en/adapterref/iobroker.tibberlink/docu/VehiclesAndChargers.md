...
> Developer/research notes on the Data API (endpoints, device schema, capabilities) live in [../info/TibberDataAPI.md](/#/docs/adapterref/iobroker.tibberlink/info/TibberDataAPI.md).
