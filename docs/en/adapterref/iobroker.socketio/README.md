...
You can find in the example [directory](https://github.com/ioBroker/ioBroker.socketio/tree/master/example) the simple application that uses this interface to show some data.
