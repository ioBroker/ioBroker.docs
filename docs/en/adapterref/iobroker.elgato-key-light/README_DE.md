...
[English](/#/adapters/elgato-key-light) | Deutsch
...
Der Probe maskiert Seriennummer, MAC-Adresse und WLAN-Namen. Einzelheiten zum Protokoll stehen in [docs/ELGATO_API.md](/#/docs/adapterref/iobroker.elgato-key-light/docs/ELGATO_API.md).
...
Veröffentlicht unter der MIT-Lizenz. Siehe [LICENSE](https://github.com/iobroker-community-adapters/ioBroker.elgato-key-light/blob/main/LICENSE).