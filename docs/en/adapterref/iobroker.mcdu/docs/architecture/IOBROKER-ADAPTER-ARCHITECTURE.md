...
### MCDU Resources
- **Phase 3a Spec:** [PHASE3A-SPEC.md](https://github.com/Flixhummel/ioBroker.mcdu/blob/main/docs/architecture/PHASE3A-SPEC.md)
- **MQTT Protocol:** [MQTT-TEST-COMMANDS.md](https://github.com/Flixhummel/ioBroker.mcdu/blob/main/docs/architecture/MQTT-TEST-COMMANDS.md)
- **Hardware Driver:** [lib/mcdu.js](https://github.com/Flixhummel/ioBroker.mcdu/blob/main/docs/architecture/lib/mcdu.js)
