...
2. Official adapter index: **[ioBroker.repositories](https://github.com/ioBroker/ioBroker.repositories)** (**latest**). Maintainer workflow / PR: **[TODO — § 1.1 Release](/#/docs/adapterref/iobroker.autodoc/TODO.md#release-veroeffentlichung)**.
...
Short **orientation** for operators (install paths, tabs, exports, hashes, checker): **[`docs/user-guide/README.md`](/#/docs/adapterref/iobroker.autodoc/docs/user-guide/README.md)** · **German** config wiki (tabs, screenshots, demo scenario): **[`docs/user-guide/README.de.md`](/#/docs/adapterref/iobroker.autodoc/docs/user-guide/README.de.md)**.
...
- Rationale, options, and future media work: [`PLAN.md` — Media (MVP) & limits](/#/docs/adapterref/iobroker.autodoc/PLAN.md#architektur-medien-mvp) and [Architecture boundaries](/#/docs/adapterref/iobroker.autodoc/PLAN.md#architektur-grenzen).
...
German **scenario page** (“hide first vs reorder”, copy-paste walkthrough anchored to Step 6): **[`README.de.md` — Wiki — Step 6](/#/docs/adapterref/iobroker.autodoc/docs/user-guide/README.de.md#wiki-admin-json-cookbook)** (`docs/user-guide/`).
...
- Multilingual Admin UI strings (EN / DE / FR full; more locales with English copy until translated — [CONTRIBUTING](/#/docs/adapterref/iobroker.autodoc/CONTRIBUTING.md#admin-ui-translations-i18n)); generated documentation text follows **Documentation language**, including changelog/compare summary lines and optional inventory-change notices in User exports
- Optional AI providers (e.g. Ollama, Groq, Anthropic) with strict opt-in

For **roadmap and planning**: [`TODO.md`](/#/docs/adapterref/iobroker.autodoc/TODO.md) (open work at the top, full completed checklists in the appendix) and [`PLAN.md`](/#/docs/adapterref/iobroker.autodoc/PLAN.md) (vision, rationale, architecture brainstorming).

**Contributing / releases:** see [`CONTRIBUTING.md`](/#/docs/adapterref/iobroker.autodoc/CONTRIBUTING.md).
