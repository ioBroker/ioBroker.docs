...
This is the English documentation - [🇩🇪 German version](https://github.com/iobroker-community-adapters/ioBroker.shelly/blob/master/docs/de/restricted-login.md)
...
- Configure the same password on all devices
    ...
    - Generation 2+: Configure just the password of the Shelly instance
