...
Die IPv4-Adresse des trivum MusicCenters eintragen. Zonen und Steuerungen werden automatisch erkannt. Abfrageintervall und HTTP-Timeout sind konfigurierbar; bestehende Installationen behalten die historischen Konfigurationsschlüssel `adresse` und `option3`.
