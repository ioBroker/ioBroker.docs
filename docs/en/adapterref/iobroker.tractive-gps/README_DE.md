...
> [English documentation](/#/adapters/tractive-gps)
...
Informationen für Mitwirkende stehen in der [Entwicklerdokumentation](/#/docs/adapterref/iobroker.tractive-gps/docs/DEVELOPMENT.md).
