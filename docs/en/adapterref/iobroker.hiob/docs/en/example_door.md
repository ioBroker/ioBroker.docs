...
-   `door_states` The states that are to be monitored must now be added and named here. These objects are then created under alias.0.<alias_object_name>. If an object needs to be changed or deleted, please make this change in Blockly. Objects that are not inserted here are automatically checked at 2 p.m. and can be deleted. This review can be set up below. The states can only have 0, 1, true or false!
...
-   **Create Table and select State**
  ...
  ![example_door_table_create.png](img/example_door/example_door_table_create.png)

-   **Create Columns add**

  ![example_door_table_column_name.png](img/example_door/example_door_table_column_name.png)</br>
  ![example_door_table_column_status.png](img/example_door/example_door_table_column_status.png)</br>
  ![example_door_table_column_done.png](img/example_door/example_door_table_column_done.png)

-   **Created Widget**

  ![example_door_table_done.png](img/example_door/example_door_table_done.png)

-   **Create Screen**

  ![example_door_screen_create.png](img/example_door/example_door_screen_create.png)</br>
  ![example_door_screen_create_icon.png](img/example_door/example_door_screen_create_icon.png)
...
### 7.   Done
  ...
  ![example_door.gif](img/example_door/example_door.gif)
