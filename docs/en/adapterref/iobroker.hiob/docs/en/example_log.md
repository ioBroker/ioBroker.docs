...
### 1.   Install Adapter Log Parser

![example_log_logparser.png](img/example_log_logparser.png)

### 2.   Set your own filters (Debug and All were added)

![example_log_logparser_instance.png](img/example_log_logparser_instance.png)

### 3.   Import Blockly Script
...
-   **Create Columns add**
  ...
  ![example_log_app_table_1.png](img/example_log_app_table_1.png)
...
-   **Add widgets and create a group**
  ...
  ![example_log_app_screen.png](img/example_log_app_screen.png)
...
### 9.   Done
  ...
  ![example_log_app_screen_ready_gif.gif](img/example_log_app_screen_ready_gif.gif)
